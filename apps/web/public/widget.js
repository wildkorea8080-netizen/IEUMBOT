"use strict";(()=>{var A=Object.defineProperty;var S=(t,e,i)=>e in t?A(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var s=(t,e,i)=>S(t,typeof e!="symbol"?e+"":e,i);function B(t){return t.endsWith("/")?t.slice(0,-1):t}var b=class{constructor(e){s(this,"baseUrl");this.baseUrl=B(e)}async getConfig(e){let i=await fetch(`${this.baseUrl}/widget/config/${encodeURIComponent(e)}`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"omit"});if(!i.ok)throw new Error(`WIDGET_CONFIG_FAILED:${i.status}`);return await i.json()}async sendChat(e,i="/chat/messages"){let n=i.startsWith("/")?i:`/${i}`,o=await fetch(`${this.baseUrl}${n}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`WIDGET_CHAT_FAILED:${o.status}`);return await o.json()}async streamChat(e,i,n="/chat/messages/stream"){let o=n.startsWith("/")?n:`/${n}`,r=await fetch(`${this.baseUrl}${o}`,{method:"POST",headers:{"Content-Type":"application/json",Accept:"text/event-stream"},body:JSON.stringify(e),credentials:"omit"});if(!r.ok||!r.body)throw new Error(`WIDGET_CHAT_STREAM_FAILED:${r.status}`);let d=r.body.getReader(),u=new TextDecoder("utf-8"),l="";for(;;){let{value:y,done:h}=await d.read();if(h)break;l+=u.decode(y,{stream:!0});let p=l.indexOf(`

`);for(;p!==-1;){let c=l.slice(0,p).trim();if(l=l.slice(p+2),p=l.indexOf(`
...
`));i({event:k,data:g})}catch{i({event:"error",data:{code:"STREAM_EVENT_PARSE_FAILED",message:"\uC2A4\uD2B8\uB9BC \uC774\uBCA4\uD2B8 \uD30C\uC2F1 \uC2E4\uD328"}})}}}}};var H="/widget-icons/love-chat-icons.png";function D(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function L(t){return`<img class="ieum-launcher-image" src="${D(t.trim())}" alt="" aria-hidden="true" />`}function a(t,e,i){let n=t.createElement(e);return i&&(n.className=i),n}function m(t,e){return t==="custom"&&e?.trim()?L(e):t==="love-chat"?L(H):t==="heart"?`
  ...
  `}function _(t){return t&&t.trim()?t.replace(/\/$/,""):`${window.location.origin}/api`}function f(t){return typeof t=="string"?t:void 0}function N(t){return typeof t=="boolean"?t:void 0}function O(t){return Array.isArray(t)?t:[]}function $(t){return!t||t==="answered"?null:t==="insufficient_evidence"?"\uD655\uC778 \uAC00\uB2A5\uD55C \uCC38\uACE0 \uB0B4\uC6A9\uC774 \uBD80\uC871\uD574 \uC77C\uBC18 \uC548\uB0B4\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4.":t==="restricted"?"\uC9C1\uC811 \uC548\uB0B4\uAC00 \uC5B4\uB824\uC6B4 \uC9C8\uBB38\uC774\uB77C \uC548\uC804\uD55C \uBC94\uC704\uC5D0\uC11C\uB9CC \uB2F5\uBCC0\uD569\uB2C8\uB2E4.":t==="conflict"?"\uADFC\uAC70 \uD655\uC778\uC774 \uB354 \uD544\uC694\uD55C \uC9C8\uBB38\uC785\uB2C8\uB2E4.":t==="escalate"?"\uCD94\uAC00 \uD655\uC778\uC774 \uD544\uC694\uD55C \uB0B4\uC6A9\uC73C\uB85C \uC0C1\uB2F4 \uC5F0\uACB0\uC774 \uAD8C\uC7A5\uB429\uB2C8\uB2E4.":null}function q(t){let e=t.documentName?.trim()||"\uCD9C\uCC98",i=t.pageNumber?`p.${t.pageNumber}`:null,n=t.sectionTitle?.trim()||null,o=t.sourceUrl?.trim()||null,r=[e];return i&&r.push(i),n&&n!==e&&n!==o&&r.push(n),o&&r.push(o),r.join(" | ")}function C(t,e){return e.title?.trim()||t?.institutionName?.trim()||t?.chatbotName?.trim()||"\uAE30\uAD00"}function M(t,e){let i=C(t,e);return i.startsWith("AI \uCC57\uBD07")?i:`AI \uCC57\uBD07 ${i}`}function R(t,e){return e.welcomeMessage?.trim()?e.welcomeMessage.trim():t?.introMessage?.trim()?t.introMessage.trim():t?.welcomeMessage?.trim()?t.welcomeMessage.trim():`\uC548\uB155\uD558\uC138\uC694
${C(t,e)} AI \uCC57\uBD07\uC785\uB2C8\uB2E4.

\uAD81\uAE08\uD558\uC2E0 \uB0B4\uC6A9\uC744 \uC785\uB825\uD574\uC8FC\uC2DC\uBA74
\uBE60\uB974\uAC8C \uC548\uB0B4\uD574\uB4DC\uB9AC\uACA0\uC2B5\uB2C8\uB2E4.`}function E(t){return t==="forest"?"linear-gradient(135deg, #166534, #0f766e)":t==="sky"?"linear-gradient(135deg, #1d4ed8, #0284c7)":t==="civic"?"linear-gradient(135deg, #1e40af, #0f766e)":t==="sunset"?"linear-gradient(135deg, #b45309, #ea580c)":"linear-gradient(135deg, #2563EB, #22C55E)"}function P(t){let e=t?.theme?.launcherIcon;return e==="custom"&&t?.theme?.launcherIconUrl?.trim()?"custom":e==="love-chat"||e==="heart"||e==="shield"||e==="leaf"||e==="spark"?e:"chat"}function Q(t,e){return t==="love-chat"||t==="custom"&&!!e?.trim()}function j(t,e){let i=t?.launcherHoverMessage?.trim();return i||`AI\uCC57\uBD07 ${C(t,e)}\uC608\uC694. \uBB34\uC5C7\uC744 \uB3C4\uC640\uB4DC\uB9B4\uAE4C\uC694?`}function W(t){return`
:host { all: initial; }
.ieum-root, .ieum-root * {
...
`}var x=class{constructor(e){s(this,"options");s(this,"api");s(this,"host");s(this,"shadow");s(this,"root");s(this,"launcherWrap");s(this,"launcherTip");s(this,"launcherTipText");s(this,"launcherTipClose");s(this,"floatingButton");s(this,"panel");s(this,"titleNode");s(this,"headerIconNode");s(this,"bannerWrap");s(this,"starterQuestionsWrap");s(this,"quickActionsWrap");s(this,"messagesWrap");s(this,"loadingRow");s(this,"input");s(this,"sendButton");s(this,"footerNotice");s(this,"initialized",!1);s(this,"open",!1);s(this,"sending",!1);s(this,"launcherTipDismissed",!1);s(this,"launcherHoverMessage","");s(this,"launcherTipStorageKey","");s(this,"sessionToken",`widget_${Math.random().toString(36).slice(2,10)}_${Date.now().toString(36)}`);s(this,"config",null);s(this,"chatEndpoint","/chat/messages");s(this,"chatStreamEndpoint","/chat/messages/stream");s(this,"sseEnabled",!1);s(this,"messages",[]);s(this,"lastFailedQuestion",null);this.options=e,this.api=new b(_(e.apiBaseUrl)),this.host=document.createElement("div"),this.host.setAttribute("data-ieumbot-widget-root","true"),this.host.setAttribute("data-ieumbot-chatbot-id",e.chatbotId),this.shadow=this.host.attachShadow({mode:"open"}),this.root=a(document,"div","ieum-root"),this.launcherWrap=a(document,"div","ieum-launcher-wrap"),this.launcherTip=a(document,"div","ieum-launcher-tip"),this.launcherTipText=a(document,"div","ieum-launcher-tip-text"),this.launcherTipClose=a(document,"button","ieum-launcher-tip-close"),this.floatingButton=a(document,"button","ieum-floating"),this.panel=a(document,"div","ieum-panel"),this.titleNode=a(document,"div","ieum-title"),this.headerIconNode=a(document,"div","ieum-header-icon"),this.bannerWrap=a(document,"div","ieum-banner"),this.starterQuestionsWrap=a(document,"div","ieum-starter-questions"),this.quickActionsWrap=a(document,"div","ieum-quick-actions"),this.messagesWrap=a(document,"div","ieum-messages"),this.loadingRow=a(document,"div","ieum-loading"),this.input=a(document,"input","ieum-input"),this.sendButton=a(document,"button","ieum-send"),this.footerNotice=a(document,"div","ieum-footer"),this.launcherTipClose.type="button",this.launcherTipClose.setAttribute("aria-label","\uC548\uB0B4 \uB2EB\uAE30"),this.launcherTipClose.innerHTML=m("close"),this.launcherTip.appendChild(this.launcherTipText),this.launcherTip.appendChild(this.launcherTipClose),this.floatingButton.type="button",this.floatingButton.title=e.launcherLabel??"\uCC57\uBD07 \uC5F4\uAE30",this.floatingButton.setAttribute("aria-label",e.launcherLabel??"\uCC57\uBD07 \uC5F4\uAE30"),this.floatingButton.replaceChildren(),this.floatingButton.innerHTML=m("chat"),this.floatingButton.classList.remove("ieum-floating-image"),this.floatingButton.classList.add("ieum-floating-loading"),this.titleNode.textContent=M(null,e),this.loadingRow.innerHTML=`
      ...
      <span class="ieum-loading-dot"></span>
      <span class="ieum-loading-dot"></span>
    `,this.input.placeholder="\uBB34\uC5C7\uC744 \uB3C4\uC640\uB4DC\uB9B4\uAE4C\uC694?",this.sendButton.type="button",this.sendButton.setAttribute("aria-label","\uBA54\uC2DC\uC9C0 \uC804\uC1A1"),this.sendButton.innerHTML=m("send"),this.footerNotice.style.display="none"}async mount(){if(this.initialized)return;this.initialized=!0;let e=document.createElement("style");e.textContent=W(E(this.options.theme?.primaryColor??null)),this.shadow.appendChild(e),this.shadow.appendChild(this.root);let i=a(document,"div","ieum-header"),n=a(document,"div","ieum-header-main"),o=a(document,"div","ieum-header-actions"),r=a(document,"button","ieum-header-button"),d=a(document,"button","ieum-header-button"),u=a(document,"div","ieum-input-wrap");this.headerIconNode.innerHTML=m("heart"),r.type="button",r.title="\uCD5C\uC18C\uD654",r.setAttribute("aria-label","\uCD5C\uC18C\uD654"),r.innerHTML=m("minimize"),d.type="button",d.title="\uB2EB\uAE30",d.setAttribute("aria-label","\uB2EB\uAE30"),d.innerHTML=m("close"),n.appendChild(this.headerIconNode),n.appendChild(this.titleNode),o.appendChild(r),o.appendChild(d),i.appendChild(n),i.appendChild(o),u.appendChild(this.input),u.appendChild(this.sendButton),this.panel.appendChild(i),this.panel.appendChild(this.bannerWrap),this.panel.appendChild(this.messagesWrap),this.panel.appendChild(this.starterQuestionsWrap),this.panel.appendChild(this.quickActionsWrap),this.panel.appendChild(this.loadingRow),this.panel.appendChild(u),this.panel.appendChild(this.footerNotice),this.launcherWrap.appendChild(this.launcherTip),this.launcherWrap.appendChild(this.floatingButton),this.root.appendChild(this.panel),this.root.appendChild(this.launcherWrap),document.body.appendChild(this.host),this.floatingButton.addEventListener("click",()=>this.togglePanel()),this.floatingButton.addEventListener("mouseenter",()=>this.showLauncherTip()),this.floatingButton.addEventListener("focus",()=>this.showLauncherTip()),this.launcherTip.addEventListener("mouseenter",()=>this.showLauncherTip()),this.launcherTipClose.addEventListener("click",l=>{l.stopPropagation(),this.dismissLauncherTip()}),r.addEventListener("click",()=>this.setOpen(!1)),d.addEventListener("click",()=>this.setOpen(!1)),this.sendButton.addEventListener("click",()=>void this.sendCurrentInput()),this.input.addEventListener("keydown",l=>{l.key==="Enter"&&!l.shiftKey&&(l.preventDefault(),this.sendCurrentInput())}),await this.loadConfig(),this.options.openOnLoad&&this.setOpen(!0)}ensureInitialMessage(){this.messages.length>0||(this.pushMessage({id:`assistant_welcome_${Date.now()}`,role:"assistant",text:R(this.config,this.options),timestamp:Date.now()}),this.config?.operatingHours.isAfterHours&&this.config.operatingHours.message&&this.pushMessage({id:`system_after_hours_${Date.now()}`,role:"system",text:this.config.operatingHours.message,timestamp:Date.now()}))}clearInitialWelcomeForDirectQuestion(){if(this.messages.some(i=>i.role==="user"))return;let e=this.messages.filter(i=>!i.id.startsWith("assistant_welcome_"));e.length!==this.messages.length&&(this.messages=e,this.renderMessages())}readLauncherTipDismissed(){if(!this.launcherTipStorageKey)return!1;try{return window.localStorage.getItem(this.launcherTipStorageKey)==="1"}catch{return!1}}dismissLauncherTip(){if(this.launcherTipDismissed=!0,this.hideLauncherTip(!0),!!this.launcherTipStorageKey)try{window.localStorage.setItem(this.launcherTipStorageKey,"1")}catch{}}showLauncherTip(){this.open||this.launcherTipDismissed||!this.launcherHoverMessage.trim()||this.launcherTip.classList.add("visible")}hideLauncherTip(e=!1){e&&this.launcherTip.classList.remove("visible")}async loadConfig(){try{this.config=await this.api.getConfig(this.options.chatbotId);let e=this.shadow.querySelector("style");e&&(e.textContent=W(E(this.config.theme?.preset))),this.titleNode.textContent=M(this.config,this.options),this.config.logoUrl?.trim()?this.headerIconNode.innerHTML=`<img src="${this.config.logoUrl}" alt="\uAE30\uAD00 \uB85C\uACE0" />`:this.headerIconNode.innerHTML=m("heart");let i=P(this.config),n=this.config.theme?.launcherIconUrl;this.floatingButton.replaceChildren(),this.floatingButton.innerHTML=m(i,n),this.floatingButton.classList.toggle("ieum-floating-image",Q(i,n)),this.launcherHoverMessage=j(this.config,this.options)??"",this.launcherTipText.textContent=this.launcherHoverMessage,this.launcherTipStorageKey=`ieumbot_launcher_tip_dismissed:${this.options.chatbotId}`,this.launcherTipDismissed=this.readLauncherTipDismissed(),window.matchMedia("(max-width: 640px)").matches&&!this.launcherTipDismissed&&this.showLauncherTip(),this.renderBanner(),this.renderStarterQuestions(),this.config.privacyNotice&&(this.footerNotice.textContent=this.config.privacyNotice,this.footerNotice.style.display="block"),this.renderQuickActions(this.config.quickActions),this.config.runtime?.chatEndpoint&&(this.chatEndpoint=this.config.runtime.chatEndpoint),this.config.runtime?.chatStreamEndpoint&&(this.chatStreamEndpoint=this.config.runtime.chatStreamEndpoint),this.sseEnabled=N(this.config.runtime?.sseEnabled)===!0||this.config.runtime?.streamingMode==="sse_preferred",this.ensureInitialMessage()}catch{this.pushMessage({id:`system_load_error_${Date.now()}`,role:"system",text:"\uCD08\uAE30 \uC124\uC815\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694.",timestamp:Date.now()})}finally{this.floatingButton.classList.remove("ieum-floating-loading")}}renderBanner(){this.bannerWrap.innerHTML="";let e=this.config?.banner?.title?.trim(),i=this.config?.banner?.description?.trim();if(!e&&!i){this.bannerWrap.style.display="none";return}if(this.bannerWrap.style.display="block",e){let n=a(document,"div","ieum-banner-title");n.textContent=e,this.bannerWrap.appendChild(n)}if(i){let n=a(document,"div","ieum-banner-description");n.textContent=i,this.bannerWrap.appendChild(n)}}renderStarterQuestions(){this.starterQuestionsWrap.innerHTML="";let e=this.config?.starterQuestions?.filter(i=>i.trim()).slice(0,4)??[];if(e.length===0){this.starterQuestionsWrap.style.display="none";return}this.starterQuestionsWrap.style.display="flex";for(let i of e){let n=a(document,"button","ieum-starter-question");n.type="button",n.textContent=i,n.addEventListener("click",()=>{this.input.value=i,this.sendCurrentInput()}),this.starterQuestionsWrap.appendChild(n)}}renderQuickActions(e){this.quickActionsWrap.innerHTML="";let i=e.filter(n=>n.displayLocation==="welcome").slice(0,6);if(i.length===0){this.quickActionsWrap.style.display="none";return}this.quickActionsWrap.style.display="flex";for(let n of i){let o=a(document,"button","ieum-quick-action");o.type="button",o.textContent=n.label,o.title=n.label,o.addEventListener("click",()=>{if(n.actionType==="link"&&n.url){window.open(n.url,"_blank","noopener,noreferrer");return}this.input.value=n.payload?.trim()||n.label,this.sendCurrentInput()}),this.quickActionsWrap.appendChild(o)}}setOpen(e){if(this.open=e,e){this.hideLauncherTip(!0),this.ensureInitialMessage(),this.panel.classList.add("open"),this.launcherWrap.style.opacity="0",this.launcherWrap.style.pointerEvents="none",this.input.focus(),this.scrollMessagesToBottom();return}this.panel.classList.remove("open"),this.launcherWrap.style.opacity="1",this.launcherWrap.style.pointerEvents="auto"}togglePanel(){this.setOpen(!this.open)}pushMessage(e){this.messages.push(e),this.renderMessages()}updateMessage(e,i){let n=this.messages.findIndex(o=>o.id===e);n<0||(this.messages[n]={...this.messages[n],...i},this.renderMessages())}removeMessage(e){this.messages=this.messages.filter(i=>i.id!==e),this.renderMessages()}renderMessages(){this.messagesWrap.innerHTML="",this.starterQuestionsWrap.style.display=this.messages.length<=1?this.starterQuestionsWrap.style.display:"none";for(let e of this.messages){let i=a(document,"div",`ieum-message ${e.role}`),n=a(document,"div","ieum-bubble");if(n.textContent=e.text,e.role==="assistant"){let o=$(e.outcome);if(o){let r=a(document,"div","ieum-outcome-note");r.textContent=o,n.appendChild(r)}if(e.citations&&e.citations.length>0){let r=a(document,"div","ieum-citations"),d=a(document,"div","ieum-citations-title");d.textContent="\uCD9C\uCC98",r.appendChild(d);for(let u of e.citations.slice(0,5)){let l=a(document,"div","ieum-citation");l.textContent=q(u),r.appendChild(l)}n.appendChild(r)}}i.appendChild(n),this.messagesWrap.appendChild(i)}if(this.lastFailedQuestion){let e=a(document,"div","ieum-message system"),i=a(document,"button","ieum-quick-action");i.type="button",i.textContent="\uB2E4\uC2DC \uC2DC\uB3C4",i.addEventListener("click",()=>{this.lastFailedQuestion&&(this.input.value=this.lastFailedQuestion,this.sendCurrentInput())}),e.appendChild(i),this.messagesWrap.appendChild(e)}this.scrollMessagesToBottom()}scrollMessagesToBottom(){requestAnimationFrame(()=>{this.messagesWrap.scrollTop=this.messagesWrap.scrollHeight})}setSending(e){this.sending=e,this.sendButton.disabled=e,this.input.disabled=e,this.loadingRow.classList.toggle("active",e)}async sendCurrentInput(){if(this.sending)return;let e=this.input.value.trim();if(e){if(this.clearInitialWelcomeForDirectQuestion(),this.lastFailedQuestion=null,this.input.value="",this.pushMessage({id:`user_${Date.now()}`,role:"user",text:e,timestamp:Date.now()}),this.setSending(!0),this.sseEnabled&&await this.trySendWithSse(e)){this.setSending(!1),this.input.focus();return}try{let i=await this.api.sendChat({chatbotId:this.options.chatbotId,question:e,topK:this.options.topK??8,sessionToken:this.sessionToken,sourceUrl:this.options.sourceUrl??window.location.href},this.chatEndpoint);this.handleAssistantResponse(i)}catch{this.lastFailedQuestion=e,this.pushMessage({id:`system_send_error_${Date.now()}`,role:"system",text:"\uC694\uCCAD \uCC98\uB9AC \uC911 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694.",timestamp:Date.now()})}finally{this.setSending(!1),this.input.focus()}}}async trySendWithSse(e){let i=`assistant_stream_${Date.now()}`,n=!1,o="\uC2A4\uD2B8\uB9AC\uBC0D \uC5F0\uACB0 \uC624\uB958\uB85C \uC77C\uBC18 \uBAA8\uB4DC\uB85C \uC804\uD658\uD569\uB2C8\uB2E4.",r="answered",d=[],u="",l=!1;this.pushMessage({id:i,role:"assistant",text:"",timestamp:Date.now()});let y=h=>{let p=h.data??{};if(h.event==="message_delta"){let c=f(p.delta)??"";u+=c,c&&(l=!0),this.updateMessage(i,{text:u});return}if(h.event==="message_complete"){r=f(p.outcome)??r,l=!0,this.updateMessage(i,{outcome:r,text:u||"..."});return}if(h.event==="fallback"||h.event==="escalation"){r=f(p.outcome)??(h.event==="escalation"?"escalate":"insufficient_evidence"),u=f(p.message)??"",l=!0,this.updateMessage(i,{text:u,outcome:r});return}if(h.event==="citations"){d=O(p.items),this.updateMessage(i,{citations:d});return}if(h.event==="error"){n=!0,o=f(p.message)??o;return}if(h.event==="done"){let c=f(p.sessionToken);c&&(this.sessionToken=c)}};try{if(await this.api.streamChat({chatbotId:this.options.chatbotId,question:e,topK:this.options.topK??8,sessionToken:this.sessionToken,sourceUrl:this.options.sourceUrl??window.location.href},y,this.chatStreamEndpoint),n)throw new Error(o);return u.trim()?this.updateMessage(i,{text:u,outcome:r,citations:d}):this.updateMessage(i,{text:"\uC694\uCCAD\uC744 \uCC98\uB9AC\uD558\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.",outcome:"insufficient_evidence"}),!0}catch{return l?(this.updateMessage(i,{text:u||"\uC751\uB2F5 \uC218\uC2E0 \uC911 \uC5F0\uACB0\uC774 \uC885\uB8CC\uB418\uC5C8\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694.",outcome:r,citations:d}),this.lastFailedQuestion=e,!0):(this.removeMessage(i),!1)}}handleAssistantResponse(e){let i=e.trace?.messages?.sessionToken;i&&typeof i=="string"&&(this.sessionToken=i);let n=e.answer?.text?.trim()||"\uC548\uB0B4 \uAC00\uB2A5\uD55C \uB2F5\uBCC0\uC744 \uC0DD\uC131\uD558\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.";this.pushMessage({id:`assistant_${e.requestId}`,role:"assistant",text:n,outcome:e.outcome,citations:Array.isArray(e.citations)?e.citations:[],timestamp:Date.now()})}};var T=new Set;async function I(t){if(!t?.chatbotId)throw new Error("WIDGET_INIT_REQUIRES_CHATBOT_ID");let e=t.chatbotId,i=Array.from(document.querySelectorAll('[data-ieumbot-widget-root="true"]'));for(let o of i)o.getAttribute("data-ieumbot-chatbot-id")===t.chatbotId&&o.remove();if(T.delete(e),T.has(e))return;await new x(t).mount(),T.add(e)}window.IEUMBOTWidget={init:I};var v=document.currentScript;if(v){let t=v.getAttribute("data-chatbot-id");t&&I({chatbotId:t,apiBaseUrl:v.getAttribute("data-api-base-url")??void 0,openOnLoad:v.getAttribute("data-open-on-load")==="true"})}})();
