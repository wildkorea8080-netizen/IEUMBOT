"use strict";(()=>{var I=Object.defineProperty;var S=(t,e,i)=>e in t?I(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var s=(t,e,i)=>S(t,typeof e!="symbol"?e+"":e,i);function A(t){return t.endsWith("/")?t.slice(0,-1):t}var b=class{constructor(e){s(this,"baseUrl");this.baseUrl=A(e)}async getConfig(e){let i=await fetch(`${this.baseUrl}/widget/config/${encodeURIComponent(e)}`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"omit"});if(!i.ok)throw new Error(`WIDGET_CONFIG_FAILED:${i.status}`);return await i.json()}async sendChat(e,i="/chat/messages"){let n=i.startsWith("/")?i:`/${i}`,r=await fetch(`${this.baseUrl}${n}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!r.ok)throw new Error(`WIDGET_CHAT_FAILED:${r.status}`);return await r.json()}async streamChat(e,i,n="/chat/messages/stream"){let r=n.startsWith("/")?n:`/${n}`,o=await fetch(`${this.baseUrl}${r}`,{method:"POST",headers:{"Content-Type":"application/json",Accept:"text/event-stream"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok||!o.body)throw new Error(`WIDGET_CHAT_STREAM_FAILED:${o.status}`);let l=o.body.getReader(),u=new TextDecoder("utf-8"),d="";for(;;){let{value:y,done:h}=await l.read();if(h)break;d+=u.decode(y,{stream:!0});let p=d.indexOf(`
...
`));i({event:T,data:g})}catch{i({event:"error",data:{code:"STREAM_EVENT_PARSE_FAILED",message:"\uC2A4\uD2B8\uB9BC \uC774\uBCA4\uD2B8 \uD30C\uC2F1 \uC2E4\uD328"}})}}}}};var H="/widget-icons/love-chat-icons.png";function a(t,e,i){let n=t.createElement(e);return i&&(n.className=i),n}function m(t,e){return t==="custom"&&e?.trim()?`<img class="ieum-launcher-image" src="${e.trim()}" alt="" aria-hidden="true" />`:t==="love-chat"?`<img class="ieum-launcher-image" src="${H}" alt="" aria-hidden="true" />`:t==="heart"?`
