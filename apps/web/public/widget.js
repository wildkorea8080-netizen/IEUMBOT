"use strict";(()=>{var S=Object.defineProperty;var D=(t,e,i)=>e in t?S(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var s=(t,e,i)=>D(t,typeof e!="symbol"?e+"":e,i);function B(t){return t.endsWith("/")?t.slice(0,-1):t}var x=class{constructor(e){s(this,"baseUrl");this.baseUrl=B(e)}async getConfig(e){let i=await fetch(`${this.baseUrl}/widget/config/${encodeURIComponent(e)}`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"omit"});if(!i.ok)throw new Error(`WIDGET_CONFIG_FAILED:${i.status}`);return await i.json()}async sendChat(e,i="/chat/messages"){let n=i.startsWith("/")?i:`/${i}`,r=await fetch(`${this.baseUrl}${n}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!r.ok)throw new Error(`WIDGET_CHAT_FAILED:${r.status}`);return await r.json()}async streamChat(e,i,n="/chat/messages/stream"){let r=n.startsWith("/")?n:`/${n}`,o=await fetch(`${this.baseUrl}${r}`,{method:"POST",headers:{"Content-Type":"application/json",Accept:"text/event-stream"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok||!o.body)throw new Error(`WIDGET_CHAT_STREAM_FAILED:${o.status}`);let l=o.body.getReader(),u=new TextDecoder("utf-8"),d="";for(;;){let{value:g,done:h}=await l.read();if(h)break;d+=u.decode(g,{stream:!0});let c=d.indexOf(`
...
`));i({event:k,data:f})}catch{i({event:"error",data:{code:"STREAM_EVENT_PARSE_FAILED",message:"\uC2A4\uD2B8\uB9BC \uC774\uBCA4\uD2B8 \uD30C\uC2F1 \uC2E4\uD328"}})}}}}};var H="/widget-icons/love-chat-icons.png",L="\uD604\uC7AC \uC790\uB3D9 \uB2F5\uBCC0 \uCC98\uB9AC\uC5D0 \uC77C\uC2DC\uC801\uC778 \uBB38\uC81C\uAC00 \uC788\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC2DC\uAC70\uB098, \uC9C8\uBB38\uC744 \uC870\uAE08 \uB354 \uAD6C\uCCB4\uC801\uC73C\uB85C \uB0A8\uACA8\uC8FC\uC2DC\uBA74 \uD655\uC778 \uAC00\uB2A5\uD55C \uBC94\uC704\uC5D0\uC11C \uB2E4\uC2DC \uC548\uB0B4\uD574 \uB4DC\uB9B4\uAC8C\uC694.";function _(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function M(t){return`<img class="ieum-launcher-image" src="${_(t.trim())}" alt="" aria-hidden="true" />`}function a(t,e,i){let n=t.createElement(e);return i&&(n.className=i),n}function m(t,e){return t==="custom"&&e?.trim()?M(e):t==="love-chat"?M(H):t==="heart"?`
  ...
  `}function N(t){return t&&t.trim()?t.replace(/\/$/,""):`${window.location.origin}/api`}function b(t){return typeof t=="string"?t:void 0}function $(t){return typeof t=="boolean"?t:void 0}function O(t){return Array.isArray(t)?t:[]}function R(t){return/^https?:\/\//i.test(t)||/^[\w.-]+\.[a-z]{2,}(?:\/|\?|$)/i.test(t)}function q(t){return!t||t==="answered"?null:t==="insufficient_evidence"?"\uD655\uC778 \uAC00\uB2A5\uD55C \uCC38\uACE0 \uB0B4\uC6A9\uC774 \uBD80\uC871\uD574 \uC77C\uBC18 \uC548\uB0B4\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4.":t==="restricted"?"\uC9C1\uC811 \uC548\uB0B4\uAC00 \uC5B4\uB824\uC6B4 \uC9C8\uBB38\uC774\uB77C \uC548\uC804\uD55C \uBC94\uC704\uC5D0\uC11C\uB9CC \uB2F5\uBCC0\uD569\uB2C8\uB2E4.":t==="conflict"?"\uADFC\uAC70 \uD655\uC778\uC774 \uB354 \uD544\uC694\uD55C \uC9C8\uBB38\uC785\uB2C8\uB2E4.":t==="escalate"?"\uCD94\uAC00 \uD655\uC778\uC774 \uD544\uC694\uD55C \uB0B4\uC6A9\uC73C\uB85C \uC0C1\uB2F4 \uC5F0\uACB0\uC774 \uAD8C\uC7A5\uB429\uB2C8\uB2E4.":null}function P(t,e){let i=e?.trim()||null,n=t.documentName?.trim()||"\uCD9C\uCC98",r=t.pageNumber?`p.${t.pageNumber}`:null,o=t.sectionTitle?.trim()||null,l=i&&i!==n?[i,n]:[n];return r&&l.push(r),o&&o!==n&&!R(o)&&l.push(o),l.join(" | ")}function Q(t){return t?.citationPresentation==="folded"||t?.citationMode==="compact"}function C(t,e){return e.title?.trim()||t?.institutionName?.trim()||t?.chatbotName?.trim()||"\uAE30\uAD00"}function E(t,e){let i=e.title?.trim()||t?.chatbotName?.trim()||C(t,e);return i.startsWith("AI \uCC57\uBD07")?i:`AI \uCC57\uBD07 ${i}`}function j(t,e){return e.welcomeMessage?.trim()?e.welcomeMessage.trim():t?.introMessage?.trim()?t.introMessage.trim():t?.welcomeMessage?.trim()?t.welcomeMessage.trim():`\uC548\uB155\uD558\uC138\uC694
${C(t,e)} AI \uCC57\uBD07\uC785\uB2C8\uB2E4.

\uAD81\uAE08\uD558\uC2E0 \uB0B4\uC6A9\uC744 \uC785\uB825\uD574\uC8FC\uC2DC\uBA74
\uBE60\uB974\uAC8C \uC548\uB0B4\uD574\uB4DC\uB9AC\uACA0\uC2B5\uB2C8\uB2E4.`}function W(t){return t==="forest"?"linear-gradient(135deg, #166534, #0f766e)":t==="sky"?"linear-gradient(135deg, #1d4ed8, #0284c7)":t==="civic"?"linear-gradient(135deg, #1e40af, #0f766e)":t==="sunset"?"linear-gradient(135deg, #b45309, #ea580c)":"linear-gradient(135deg, #2563EB, #22C55E)"}function z(t){let e=t?.theme?.launcherIcon;return e==="custom"&&t?.theme?.launcherIconUrl?.trim()?"custom":e==="love-chat"||e==="heart"||e==="shield"||e==="leaf"||e==="spark"?e:"chat"}function U(t,e){return t==="love-chat"||t==="custom"&&!!e?.trim()}function F(t,e){let i=t?.launcherHoverMessage?.trim();return i||`AI\uCC57\uBD07 ${C(t,e)}\uC608\uC694. \uBB34\uC5C7\uC744 \uB3C4\uC640\uB4DC\uB9B4\uAE4C\uC694?`}function I(t){return`
:host { all: initial; }
.ieum-root, .ieum-root * {
