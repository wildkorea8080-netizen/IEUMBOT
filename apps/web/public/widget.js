...
`));i({event:f,data:b})}catch{i({event:"error",data:{code:"STREAM_EVENT_PARSE_FAILED",message:"\uC2A4\uD2B8\uB9BC \uC774\uBCA4\uD2B8 \uD30C\uC2F1 \uC2E4\uD328"}})}}}}};function re(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function k(t){let e=t;return e=e.replace(/`([^`]+)`/g,(i,n)=>`<code>${n}</code>`),e=e.replace(/\[([^\]]+)\]\(([^)\s]+)\)/g,(i,n,s)=>`<a href="${s}">${n}</a>`),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/(^|[^*])\*([^*\n]+)\*(?!\*)/g,"$1<em>$2</em>"),e=e.replace(/(^|[^_])_([^_\n]+)_(?!_)/g,"$1<em>$2</em>"),e}function B(t){let e=t.trim();return e.startsWith("|")&&(e=e.slice(1)),e.endsWith("|")&&(e=e.slice(0,-1)),e.split("|").map(i=>i.trim())}var I=/^\s*\|.*\|\s*$/,ae=/^\s*\|?[\s:-]*-[-\s:|]*\|?\s*$/,z=/^(#{1,6})\s+(.*)$/,D=/^\s*[-*]\s+(.*)$/,N=/^\s*\d+\.\s+(.*)$/,U=/^\s*>\s+(.*)$/;function P(t){return/(^|\n)\s*\|.*\|/.test(t)||/\*\*[^*]+\*\*/.test(t)||/(^|\n)\s*[-*]\s+\S/.test(t)||/(^|\n)\s*\d+\.\s+\S/.test(t)||/(^|\n)#{1,6}\s+\S/.test(t)||/\[[^\]]+\]\([^)]+\)/.test(t)||/(^|\n)>\s+\S/.test(t)}function Q(t){let e=re(t.replace(/\r\n/g,`
`)).split(`
`),i=[],n=null,s=()=>{n&&(i.push(`</${n}>`),n=null)},o=0;for(;o<e.length;){let r=e[o];if(I.test(r)&&o+1<e.length&&ae.test(e[o+1])){s();let m=B(r);o+=2;let f=[];for(;o<e.length&&I.test(e[o]);)f.push(B(e[o])),o+=1;let g="<table><thead><tr>"+m.map(b=>`<th>${k(b)}</th>`).join("")+"</tr></thead><tbody>";for(let b of f)g+="<tr>"+b.map(x=>`<td>${k(x)}</td>`).join("")+"</tr>";g+="</tbody></table>",i.push(g);continue}let a=r.match(z);if(a){s(),i.push(`<h${a[1].length}>${k(a[2])}</h${a[1].length}>`),o+=1;continue}let l=r.match(D);if(l){n!=="ul"&&(s(),i.push("<ul>"),n="ul"),i.push(`<li>${k(l[1])}</li>`),o+=1;continue}let u=r.match(N);if(u){n!=="ol"&&(s(),i.push("<ol>"),n="ol"),i.push(`<li>${k(u[1])}</li>`),o+=1;continue}let c=r.match(U);if(c){s(),i.push(`<blockquote>${k(c[1])}</blockquote>`),o+=1;continue}if(r.trim()===""){s(),o+=1;continue}s();let p=[r];for(o+=1;o<e.length&&e[o].trim()!==""&&!I.test(e[o])&&!z.test(e[o])&&!D.test(e[o])&&!N.test(e[o])&&!U.test(e[o]);)p.push(e[o]),o+=1;i.push(`<p>${p.map(k).join("<br>")}</p>`)}return s(),i.join("")}var le=new Set(["p","br","div","span","h1","h2","h3","h4","h5","h6","strong","em","b","i","u","s","mark","code","pre","ul","ol","li","a","table","thead","tbody","tr","td","th","caption","blockquote","hr","img"]),de={a:new Set(["href","title"]),img:new Set(["src","alt","title","width","height"]),td:new Set(["colspan","rowspan"]),th:new Set(["colspan","rowspan","scope"])},ce=/<[a-zA-Z][a-zA-Z0-9]*(\s|>|\/)/;function j(t){return ce.test(t)}function O(t){let e=t.trim().toLowerCase();return!(!e||e.startsWith("javascript:")||e.startsWith("data:")||e.startsWith("vbscript:")||e.startsWith("file:"))}function q(t,e){let i=Array.from(t.children);for(let n of i){let s=n.tagName.toLowerCase();if(!le.has(s)){let r=e.createTextNode(n.textContent||"");n.replaceWith(r);continue}let o=de[s]||new Set;for(let r of Array.from(n.attributes))o.has(r.name.toLowerCase())||n.removeAttribute(r.name);if(s==="a"){let r=n.getAttribute("href")||"";O(r)||n.removeAttribute("href"),n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")}if(s==="img"){let r=n.getAttribute("src")||"";O(r)||n.removeAttribute("src")}q(n,e)}}function W(t){if(typeof window>"u"||typeof DOMParser>"u")return t.replace(/<[^>]*>/g,"");if(!t)return"";let i=new DOMParser().parseFromString(`<div id="__ieum_root__">${t}</div>`,"text/html"),n=i.getElementById("__ieum_root__");return n?(q(n,i),n.innerHTML):""}var ue="/widget-icons/love-chat-icons.png",F="\uC694\uCCAD \uCC98\uB9AC \uC911 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694.",pe="\uAC1C\uC778\uC815\uBCF4\uAC00 \uD3EC\uD568\uB41C \uB0B4\uC6A9\uC740 \uC785\uB825\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4. \uAC1C\uC778\uC815\uBCF4\uB97C \uC81C\uC678\uD558\uACE0 \uB2E4\uC2DC \uC785\uB825\uD574 \uC8FC\uC138\uC694.",K="AI \uC774\uC74C\uBD07\uB3C4 \uAC00\uB054 \uC2E4\uC218\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4. \uC911\uC694\uD55C \uC815\uBCF4\uB294 \uAF2D \uB2E4\uC2DC \uD55C\uBC88 \uD655\uC778\uD558\uC138\uC694.",he=[/\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}\b/,/\b\d{6}-[1-4]\d{6}\b/,/\b\d{4}[- ]?\d{4}[- ]?\d{4}[- ]?\d{4}\b/,/\b01[016789][- ]?\d{3,4}[- ]?\d{4}\b/,/\b(?:19|20)\d{2}[-./](?:0[1-9]|1[0-2])[-./](?:0[1-9]|[12]\d|3[01])\b/];function me(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function G(t){return`<img class="ieum-launcher-image" src="${me(t.trim())}" alt="" aria-hidden="true" />`}function d(t,e,i){let n=t.createElement(e);return i&&(n.className=i),n}function V(t,e){let i=e||"";j(i)?(t.classList.add("ieum-bubble-rich"),t.innerHTML=W(i)):P(i)?(t.classList.add("ieum-bubble-rich"),t.innerHTML=W(Q(i))):(t.classList.remove("ieum-bubble-rich"),t.textContent=i)}function y(t,e){return t==="custom"&&e?.trim()?G(e):t==="love-chat"?G(ue):t==="heart"?`
