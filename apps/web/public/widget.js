"use strict";(()=>{var D=Object.defineProperty;var B=(t,e,i)=>e in t?D(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var s=(t,e,i)=>B(t,typeof e!="symbol"?e+"":e,i);function H(t){return t.endsWith("/")?t.slice(0,-1):t}var v=class{constructor(e){s(this,"baseUrl");this.baseUrl=H(e)}async getConfig(e){let i=await fetch(`${this.baseUrl}/widget/config/${encodeURIComponent(e)}`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"omit"});if(!i.ok)throw new Error(`WIDGET_CONFIG_FAILED:${i.status}`);return await i.json()}async sendChat(e,i="/chat/messages"){let n=i.startsWith("/")?i:`/${i}`,r=await fetch(`${this.baseUrl}${n}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!r.ok)throw new Error(`WIDGET_CHAT_FAILED:${r.status}`);return await r.json()}async streamChat(e,i,n="/chat/messages/stream"){let r=n.startsWith("/")?n:`/${n}`,o=await fetch(`${this.baseUrl}${r}`,{method:"POST",headers:{"Content-Type":"application/json",Accept:"text/event-stream"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok||!o.body)throw new Error(`WIDGET_CHAT_STREAM_FAILED:${o.status}`);let l=o.body.getReader(),u=new TextDecoder("utf-8"),d="";for(;;){let{value:f,done:h}=await l.read();if(h)break;d+=u.decode(f,{stream:!0});let c=d.indexOf(`

`);for(;c!==-1;){let p=d.slice(0,c).trim();if(d=d.slice(c+2),c=d.indexOf(`

`),!p)continue;let k="message",w=[];for(let b of p.split(`
`))b.startsWith("event:")?k=b.slice(6).trim():b.startsWith("data:")&&w.push(b.slice(5).trim());if(w.length!==0)try{let b=JSON.parse(w.join(`
`));i({event:k,data:b})}catch{i({event:"error",data:{code:"STREAM_EVENT_PARSE_FAILED",message:"\uC2A4\uD2B8\uB9BC \uC774\uBCA4\uD2B8 \uD30C\uC2F1 \uC2E4\uD328"}})}}}}};var _="/widget-icons/love-chat-icons.png",L="\uC694\uCCAD \uCC98\uB9AC \uC911 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694.";function N(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function M(t){return`<img class="ieum-launcher-image" src="${N(t.trim())}" alt="" aria-hidden="true" />`}function a(t,e,i){let n=t.createElement(e);return i&&(n.className=i),n}function m(t,e){return t==="custom"&&e?.trim()?M(e):t==="love-chat"?M(_):t==="heart"?`
  ...
  `}function O(t){return t&&t.trim()?t.replace(/\/$/,""):`${window.location.origin}/api`}function x(t){return typeof t=="string"?t:void 0}function $(t){return typeof t=="boolean"?t:void 0}function R(t){return Array.isArray(t)?t:[]}function q(t){return/^https?:\/\//i.test(t)||/^[\w.-]+\.[a-z]{2,}(?:\/|\?|$)/i.test(t)}function P(t){return!t||t==="answered"?null:t==="insufficient_evidence"?"\uB4F1\uB85D\uB41C \uC790\uB8CC\uC5D0\uC11C \uAD00\uB828 \uC815\uBCF4\uB97C \uCDA9\uBD84\uD788 \uCC3E\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.":t==="restricted"?"\uC548\uC804\uD55C \uC548\uB0B4 \uBC94\uC704\uC5D0\uC11C \uB2F5\uBCC0\uC774 \uC81C\uD55C\uB41C \uC9C8\uBB38\uC785\uB2C8\uB2E4.":t==="conflict"?"\uADFC\uAC70 \uD655\uC778\uC774 \uB354 \uD544\uC694\uD55C \uC9C8\uBB38\uC785\uB2C8\uB2E4.":t==="escalate"?"\uC815\uD655\uD55C \uD655\uC778\uC774 \uD544\uC694\uD55C \uB0B4\uC6A9\uC785\uB2C8\uB2E4.":null}function Q(t,e){let i=e?.trim()||null,n=t.documentName?.trim()||"\uCD9C\uCC98",r=t.pageNumber?`p.${t.pageNumber}`:null,o=t.sectionTitle?.trim()||null,l=i&&i!==n?[i,n]:[n];return r&&l.push(r),o&&o!==n&&!q(o)&&l.push(o),l.join(" | ")}function U(t){return t?.citationPresentation==="folded"||t?.citationMode==="compact"}function C(t,e){return e.title?.trim()||t?.institutionName?.trim()||t?.chatbotName?.trim()||"\uAE30\uAD00"}function I(t,e){let i=e.title?.trim()||t?.chatbotName?.trim()||C(t,e);return i.startsWith("AI \uCC57\uBD07")?i:`AI \uCC57\uBD07 ${i}`}function j(t,e){if(e.welcomeMessage?.trim())return e.welcomeMessage.trim();if(t?.introMessage?.trim())return t.introMessage.trim();if(t?.welcomeMessage?.trim())return t.welcomeMessage.trim();let i=C(t,e);return i&&i!=="\uAE30\uAD00"?`\uC548\uB155\uD558\uC138\uC694. ${i} AI \uC0C1\uB2F4\uBD07\uC785\uB2C8\uB2E4. \uAD81\uAE08\uD558\uC2E0 \uB0B4\uC6A9\uC744 \uD3B8\uD558\uAC8C \uC785\uB825\uD574\uC8FC\uC138\uC694.`:"\uC548\uB155\uD558\uC138\uC694. \uAD81\uAE08\uD558\uC2E0 \uB0B4\uC6A9\uC744 \uC785\uB825\uD574\uC8FC\uC2DC\uBA74 \uBE60\uB974\uAC8C \uC548\uB0B4\uD574\uB4DC\uB9AC\uACA0\uC2B5\uB2C8\uB2E4."}function E(t){return t==="forest"?"linear-gradient(135deg, #166534, #0f766e)":t==="sky"?"linear-gradient(135deg, #1d4ed8, #0284c7)":t==="civic"?"linear-gradient(135deg, #1e40af, #0f766e)":t==="sunset"?"linear-gradient(135deg, #b45309, #ea580c)":"linear-gradient(135deg, #2563EB, #22C55E)"}function z(t){let e=t?.theme?.launcherIcon;return e==="custom"&&t?.theme?.launcherIconUrl?.trim()?"custom":e==="love-chat"||e==="heart"||e==="shield"||e==="leaf"||e==="spark"?e:"chat"}function F(t){let e=t.initialLauncherIcon?.trim(),i=t.initialLauncherIconUrl?.trim();return e==="custom"&&i?"custom":e==="love-chat"||e==="heart"||e==="shield"||e==="leaf"||e==="spark"?e:"chat"}function W(t,e){return t==="love-chat"||t==="custom"&&!!e?.trim()}function K(t,e){let i=t?.launcherHoverMessage?.trim();return i||`${C(t,e)} AI \uC0C1\uB2F4\uBD07\uC785\uB2C8\uB2E4. \uBB34\uC5C7\uC744 \uB3C4\uC640\uB4DC\uB9B4\uAE4C\uC694?`}function A(t){return`
:host { all: initial; }
.ieum-root, .ieum-root * {
