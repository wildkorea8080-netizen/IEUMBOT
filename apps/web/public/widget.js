...
`));t({event:f,data:b})}catch{t({event:"error",data:{code:"STREAM_EVENT_PARSE_FAILED",message:"\uC2A4\uD2B8\uB9BC \uC774\uBCA4\uD2B8 \uD30C\uC2F1 \uC2E4\uD328"}})}}}}};function re(i){return i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function k(i){let e=i;return e=e.replace(/`([^`]+)`/g,(t,n)=>`<code>${n}</code>`),e=e.replace(/\[([^\]]+)\]\(([^)\s]+)\)/g,(t,n,s)=>`<a href="${s}">${n}</a>`),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/(^|[^*])\*([^*\n]+)\*(?!\*)/g,"$1<em>$2</em>"),e=e.replace(/(^|[^_])_([^_\n]+)_(?!_)/g,"$1<em>$2</em>"),e}function z(i){let e=i.trim();return e.startsWith("|")&&(e=e.slice(1)),e.endsWith("|")&&(e=e.slice(0,-1)),e.split("|").map(t=>t.trim())}var W=/^\s*\|.*\|\s*$/,ae=/^\s*\|?[\s:-]*-[-\s:|]*\|?\s*$/,D=/^(#{1,6})\s+(.*)$/,N=/^\s*[-*]\s+(.*)$/,U=/^\s*\d+\.\s+(.*)$/,P=/^\s*>\s+(.*)$/;function O(i){return/(^|\n)\s*\|.*\|/.test(i)||/\*\*[^*]+\*\*/.test(i)||/(^|\n)\s*[-*]\s+\S/.test(i)||/(^|\n)\s*\d+\.\s+\S/.test(i)||/(^|\n)#{1,6}\s+\S/.test(i)||/\[[^\]]+\]\([^)]+\)/.test(i)||/(^|\n)>\s+\S/.test(i)}function Q(i){let e=re(i.replace(/\r\n/g,`
`)).split(`
`),t=[],n=null,s=()=>{n&&(t.push(`</${n}>`),n=null)},o=0;for(;o<e.length;){let r=e[o];if(W.test(r)&&o+1<e.length&&ae.test(e[o+1])){s();let m=z(r);o+=2;let f=[];for(;o<e.length&&W.test(e[o]);)f.push(z(e[o])),o+=1;let g="<table><thead><tr>"+m.map(b=>`<th>${k(b)}</th>`).join("")+"</tr></thead><tbody>";for(let b of f)g+="<tr>"+b.map(x=>`<td>${k(x)}</td>`).join("")+"</tr>";g+="</tbody></table>",t.push(g);continue}let a=r.match(D);if(a){s(),t.push(`<h${a[1].length}>${k(a[2])}</h${a[1].length}>`),o+=1;continue}let d=r.match(N);if(d){n!=="ul"&&(s(),t.push("<ul>"),n="ul"),t.push(`<li>${k(d[1])}</li>`),o+=1;continue}let p=r.match(U);if(p){n!=="ol"&&(s(),t.push("<ol>"),n="ol"),t.push(`<li>${k(p[1])}</li>`),o+=1;continue}let c=r.match(P);if(c){s(),t.push(`<blockquote>${k(c[1])}</blockquote>`),o+=1;continue}if(r.trim()===""){s(),o+=1;continue}s();let u=[r];for(o+=1;o<e.length&&e[o].trim()!==""&&!W.test(e[o])&&!D.test(e[o])&&!N.test(e[o])&&!U.test(e[o])&&!P.test(e[o]);)u.push(e[o]),o+=1;t.push(`<p>${u.map(k).join("<br>")}</p>`)}return s(),t.join("")}var le=new Set(["p","br","div","span","section","article","header","footer","small","sub","sup","h1","h2","h3","h4","h5","h6","strong","em","b","i","u","s","mark","code","pre","ul","ol","li","a","table","thead","tbody","tr","td","th","caption","colgroup","col","blockquote","hr","figure","figcaption","img"]),de={a:new Set(["href","title"]),img:new Set(["src","alt","title","width","height"]),td:new Set(["colspan","rowspan"]),th:new Set(["colspan","rowspan","scope"]),col:new Set(["span"]),colgroup:new Set(["span"])},ce=new Set(["color","background","background-color","margin","margin-top","margin-right","margin-bottom","margin-left","padding","padding-top","padding-right","padding-bottom","padding-left","gap","row-gap","column-gap","border","border-top","border-right","border-bottom","border-left","border-width","border-style","border-color","border-radius","border-collapse","border-spacing","font","font-size","font-weight","font-style","font-family","line-height","letter-spacing","text-align","text-decoration","text-transform","white-space","word-break","overflow-wrap","vertical-align","width","min-width","max-width","height","min-height","max-height","box-sizing","display","flex","flex-direction","flex-wrap","flex-grow","flex-shrink","flex-basis","align-items","align-self","justify-content","justify-items","grid-template-columns","grid-template-rows","grid-gap","list-style","list-style-type","list-style-position","box-shadow","opacity","overflow","overflow-x","overflow-y"]);function pe(i){let e=[];for(let t of i.split(";")){let n=t.indexOf(":");if(n<0)continue;let s=t.slice(0,n).trim().toLowerCase(),o=t.slice(n+1).trim();if(!ce.has(s))continue;let r=o.toLowerCase();r.includes("url(")||r.includes("expression")||r.includes("javascript:")||r.includes("@import")||r.includes("</")||r.includes("fixed")||r.includes("absolute")||r.includes("sticky")||e.push(`${s}: ${o}`)}return e.join("; ")}var ue=/<[a-zA-Z][a-zA-Z0-9]*(\s|>|\/)/;function q(i){return ue.test(i)}function j(i){let e=i.trim().toLowerCase();return!(!e||e.startsWith("javascript:")||e.startsWith("data:")||e.startsWith("vbscript:")||e.startsWith("file:"))}function F(i,e){let t=Array.from(i.children);for(let n of t){let s=n.tagName.toLowerCase();if(!le.has(s)){let r=e.createTextNode(n.textContent||"");n.replaceWith(r);continue}let o=de[s]||new Set;for(let r of Array.from(n.attributes)){let a=r.name.toLowerCase();if(a==="style"){let d=pe(r.value);d?n.setAttribute("style",d):n.removeAttribute("style");continue}o.has(a)||n.removeAttribute(r.name)}if(s==="a"){let r=n.getAttribute("href")||"";j(r)||n.removeAttribute("href"),n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")}if(s==="img"){let r=n.getAttribute("src")||"";j(r)||n.removeAttribute("src")}F(n,e)}}function _(i){if(typeof window>"u"||typeof DOMParser>"u")return i.replace(/<[^>]*>/g,"");if(!i)return"";let t=new DOMParser().parseFromString(`<div id="__ieum_root__">${i}</div>`,"text/html"),n=t.getElementById("__ieum_root__");return n?(F(n,t),n.innerHTML):""}var he="/widget-icons/love-chat-icons.png",K="\uC694\uCCAD \uCC98\uB9AC \uC911 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694.",me="\uAC1C\uC778\uC815\uBCF4\uAC00 \uD3EC\uD568\uB41C \uB0B4\uC6A9\uC740 \uC785\uB825\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4. \uAC1C\uC778\uC815\uBCF4\uB97C \uC81C\uC678\uD558\uACE0 \uB2E4\uC2DC \uC785\uB825\uD574 \uC8FC\uC138\uC694.",V="AI \uC774\uC74C\uBD07\uB3C4 \uAC00\uB054 \uC2E4\uC218\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4. \uC911\uC694\uD55C \uC815\uBCF4\uB294 \uAF2D \uB2E4\uC2DC \uD55C\uBC88 \uD655\uC778\uD558\uC138\uC694.",fe=[/\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}\b/,/\b\d{6}-[1-4]\d{6}\b/,/\b\d{4}[- ]?\d{4}[- ]?\d{4}[- ]?\d{4}\b/,/\b01[016789][- ]?\d{3,4}[- ]?\d{4}\b/,/\b(?:19|20)\d{2}[-./](?:0[1-9]|1[0-2])[-./](?:0[1-9]|[12]\d|3[01])\b/];function ge(i){return i.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Y(i){return`<img class="ieum-launcher-image" src="${ge(i.trim())}" alt="" aria-hidden="true" />`}function l(i,e,t){let n=i.createElement(e);return t&&(n.className=t),n}function M(i,e){let t=e||"";q(t)?(i.classList.add("ieum-bubble-rich"),i.innerHTML=_(t)):O(t)?(i.classList.add("ieum-bubble-rich"),i.innerHTML=_(Q(t))):(i.classList.remove("ieum-bubble-rich"),i.textContent=t)}function y(i,e){return i==="custom"&&e?.trim()?Y(e):i==="love-chat"?Y(he):i==="heart"?`
