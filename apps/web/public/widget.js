"use strict";(()=>{var A=Object.defineProperty;var B=(t,e,i)=>e in t?A(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var s=(t,e,i)=>B(t,typeof e!="symbol"?e+"":e,i);function D(t){return t.endsWith("/")?t.slice(0,-1):t}var b=class{constructor(e){s(this,"baseUrl");this.baseUrl=D(e)}async getConfig(e){let i=await fetch(`${this.baseUrl}/widget/config/${encodeURIComponent(e)}`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"omit"});if(!i.ok)throw new Error(`WIDGET_CONFIG_FAILED:${i.status}`);return await i.json()}async sendChat(e,i="/chat/messages"){let n=i.startsWith("/")?i:`/${i}`,o=await fetch(`${this.baseUrl}${n}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok)throw new Error(`WIDGET_CHAT_FAILED:${o.status}`);return await o.json()}async streamChat(e,i,n="/chat/messages/stream"){let o=n.startsWith("/")?n:`/${n}`,r=await fetch(`${this.baseUrl}${o}`,{method:"POST",headers:{"Content-Type":"application/json",Accept:"text/event-stream"},body:JSON.stringify(e),credentials:"omit"});if(!r.ok||!r.body)throw new Error(`WIDGET_CHAT_STREAM_FAILED:${r.status}`);let d=r.body.getReader(),u=new TextDecoder("utf-8"),l="";for(;;){let{value:y,done:p}=await d.read();if(p)break;l+=u.decode(y,{stream:!0});let h=l.indexOf(`

`);for(;h!==-1;){let c=l.slice(0,h).trim();if(l=l.slice(h+2),h=l.indexOf(`
