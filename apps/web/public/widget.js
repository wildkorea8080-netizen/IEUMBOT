...
`),i=[],n=null,o=()=>{n&&(i.push(`</${n}>`),n=null)},s=0;for(;s<e.length;){let r=e[s];if(M.test(r)&&s+1<e.length&&ie.test(e[s+1])){o();let f=W(r);s+=2;let m=[];for(;s<e.length&&M.test(e[s]);)m.push(W(e[s])),s+=1;let b="<table><thead><tr>"+f.map(x=>`<th>${w(x)}</th>`).join("")+"</tr></thead><tbody>";for(let x of m)b+="<tr>"+x.map(G=>`<td>${w(G)}</td>`).join("")+"</tr>";b+="</tbody></table>",i.push(b);continue}let l=r.match(_);if(l){o(),i.push(`<h${l[1].length}>${w(l[2])}</h${l[1].length}>`),s+=1;continue}let a=r.match($);if(a){n!=="ul"&&(o(),i.push("<ul>"),n="ul"),i.push(`<li>${w(a[1])}</li>`),s+=1;continue}let u=r.match(H);if(u){n!=="ol"&&(o(),i.push("<ol>"),n="ol"),i.push(`<li>${w(u[1])}</li>`),s+=1;continue}let d=r.match(S);if(d){o(),i.push(`<blockquote>${w(d[1])}</blockquote>`),s+=1;continue}if(r.trim()===""){o(),s+=1;continue}o();let h=[r];for(s+=1;s<e.length&&e[s].trim()!==""&&!M.test(e[s])&&!_.test(e[s])&&!$.test(e[s])&&!H.test(e[s])&&!S.test(e[s]);)h.push(e[s]),s+=1;i.push(`<p>${h.map(w).join("<br>")}</p>`)}return o(),i.join("")}var ne=new Set(["p","br","div","span","h1","h2","h3","h4","h5","h6","strong","em","b","i","u","s","mark","code","pre","ul","ol","li","a","table","thead","tbody","tr","td","th","caption","blockquote","hr","img"]),se={a:new Set(["href","title"]),img:new Set(["src","alt","title","width","height"]),td:new Set(["colspan","rowspan"]),th:new Set(["colspan","rowspan","scope"])},oe=/<[a-zA-Z][a-zA-Z0-9]*(\s|>|\/)/;function z(t){return oe.test(t)}function D(t){let e=t.trim().toLowerCase();return!(!e||e.startsWith("javascript:")||e.startsWith("data:")||e.startsWith("vbscript:")||e.startsWith("file:"))}function U(t,e){let i=Array.from(t.children);for(let n of i){let o=n.tagName.toLowerCase();if(!ne.has(o)){let r=e.createTextNode(n.textContent||"");n.replaceWith(r);continue}let s=se[o]||new Set;for(let r of Array.from(n.attributes))s.has(r.name.toLowerCase())||n.removeAttribute(r.name);if(o==="a"){let r=n.getAttribute("href")||"";D(r)||n.removeAttribute("href"),n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")}if(o==="img"){let r=n.getAttribute("src")||"";D(r)||n.removeAttribute("src")}U(n,e)}}function A(t){if(typeof window>"u"||typeof DOMParser>"u")return t.replace(/<[^>]*>/g,"");if(!t)return"";let i=new DOMParser().parseFromString(`<div id="__ieum_root__">${t}</div>`,"text/html"),n=i.getElementById("__ieum_root__");return n?(U(n,i),n.innerHTML):""}var re="/widget-icons/love-chat-icons.png",N="\uC694\uCCAD \uCC98\uB9AC \uC911 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694.",ae="\uAC1C\uC778\uC815\uBCF4\uAC00 \uD3EC\uD568\uB41C \uB0B4\uC6A9\uC740 \uC785\uB825\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4. \uAC1C\uC778\uC815\uBCF4\uB97C \uC81C\uC678\uD558\uACE0 \uB2E4\uC2DC \uC785\uB825\uD574 \uC8FC\uC138\uC694.",Q="AI \uC774\uC74C\uBD07\uB3C4 \uAC00\uB054 \uC2E4\uC218\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4. \uC911\uC694\uD55C \uC815\uBCF4\uB294 \uAF2D \uB2E4\uC2DC \uD55C\uBC88 \uD655\uC778\uD558\uC138\uC694.",le=[/\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}\b/,/\b\d{6}-[1-4]\d{6}\b/,/\b\d{4}[- ]?\d{4}[- ]?\d{4}[- ]?\d{4}\b/,/\b01[016789][- ]?\d{3,4}[- ]?\d{4}\b/,/\b(?:19|20)\d{2}[-./](?:0[1-9]|1[0-2])[-./](?:0[1-9]|[12]\d|3[01])\b/];function ce(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function P(t){return`<img class="ieum-launcher-image" src="${ce(t.trim())}" alt="" aria-hidden="true" />`}function c(t,e,i){let n=t.createElement(e);return i&&(n.className=i),n}function O(t,e){let i=e||"";z(i)?(t.classList.add("ieum-bubble-rich"),t.innerHTML=A(i)):R(i)?(t.classList.add("ieum-bubble-rich"),t.innerHTML=A(B(i))):(t.classList.remove("ieum-bubble-rich"),t.textContent=i)}function v(t,e){return t==="custom"&&e?.trim()?P(e):t==="love-chat"?P(re):t==="heart"?`
  ...
  `}function de(t){return t&&t.trim()?t.replace(/\/$/,""):`${window.location.origin}/api`}function k(t){return typeof t=="string"?t:void 0}function ue(t){return typeof t=="boolean"?t:void 0}function pe(t){return Array.isArray(t)?t:[]}function he(t){return Array.isArray(t)?t:[]}var g='fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"',K={doc:`<svg viewBox="0 0 24 24" ${g}><path d="M6 3h8l4 4v14H6z"/><path d="M14 3v4h4"/><path d="M9 12h6M9 16h6"/></svg>`,shield:`<svg viewBox="0 0 24 24" ${g}><path d="M12 3l7 3v5c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6z"/><path d="M9 12l2 2 4-4"/></svg>`,member:`<svg viewBox="0 0 24 24" ${g}><circle cx="10" cy="8" r="3.2"/><path d="M4 20c0-3.3 2.7-5.6 6-5.6 1.2 0 2.3.3 3.2.8"/><path d="M18 14v6M15 17h6"/></svg>`,cert:`<svg viewBox="0 0 24 24" ${g}><circle cx="12" cy="9" r="5.2"/><path d="M9.7 9l1.6 1.6 3-3.2"/><path d="M8.5 13.2 7 20l5-2.6L17 20l-1.5-6.8"/></svg>`,search:`<svg viewBox="0 0 24 24" ${g}><circle cx="11" cy="11" r="6"/><path d="M20 20l-4.3-4.3"/></svg>`,phone:`<svg viewBox="0 0 24 24" ${g}><path d="M6.6 10.8a12 12 0 0 0 5.6 5.6l1.9-1.9a1 1 0 0 1 1-.24 11 11 0 0 0 3.4.55 1 1 0 0 1 1 1V20a1 1 0 0 1-1 1A16 16 0 0 1 3 5a1 1 0 0 1 1-1h3.3a1 1 0 0 1 1 1 11 11 0 0 0 .55 3.4 1 1 0 0 1-.24 1z"/></svg>`,apply:`<svg viewBox="0 0 24 24" ${g}><path d="M5 4h9l4 4v6"/><path d="M14 4v4h4"/><path d="M13 21l-4 1 1-4 6.5-6.5a1.4 1.4 0 0 1 2 2z"/></svg>`,check:`<svg viewBox="0 0 24 24" ${g}><circle cx="12" cy="12" r="8.5"/><path d="M8.5 12.5l2.5 2.5 4.5-5"/></svg>`,info:`<svg viewBox="0 0 24 24" ${g}><circle cx="12" cy="12" r="8.5"/><path d="M12 11v5"/><path d="M12 8h.01"/></svg>`,won:`<svg viewBox="0 0 24 24" ${g}><circle cx="12" cy="12" r="8.5"/><path d="M8 9l1.6 6L12 10l2.4 5L16 9"/><path d="M7.4 11.5h9.2"/></svg>`,grid:`<svg viewBox="0 0 24 24" ${g}><rect x="4" y="4" width="7" height="7" rx="1.5"/><rect x="13" y="4" width="7" height="7" rx="1.5"/><rect x="4" y="13" width="7" height="7" rx="1.5"/><rect x="13" y="13" width="7" height="7" rx="1.5"/></svg>`,chat:`<svg viewBox="0 0 24 24" ${g}><path d="M4 5h16v11H9l-4 3v-3H4z"/><path d="M8 9h8M8 12h5"/></svg>`,calendar:`<svg viewBox="0 0 24 24" ${g}><rect x="4" y="5" width="16" height="15" rx="2"/><path d="M4 9h16M8 3v4M16 3v4"/></svg>`,building:`<svg viewBox="0 0 24 24" ${g}><path d="M5 21V5a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v16"/><path d="M15 9h3a1 1 0 0 1 1 1v11"/><path d="M8 8h4M8 12h4M8 16h4"/></svg>`},me=/^(https?:\/\/|tel:|mailto:|\/)/i;function fe(t){let e=t.trim(),i="none",n="",o=e,s=e.match(/^\[([a-z0-9_-]+)\]\s*(.*)$/i);if(s&&K[s[1].toLowerCase()])i="svg",n=s[1].toLowerCase(),o=s[2].trim();else{let a=e.search(/\s/);if(a>0){let u=e.slice(0,a);!/[0-9A-Za-z가-힣]/.test(u)&&/[←-⯿️‍]|[\u{1F000}-\u{1FAFF}]/u.test(u)&&(i="emoji",n=u,o=e.slice(a+1).trim())}}let r="",l=o.lastIndexOf(" | ");if(l>0){let a=o.slice(l+3).trim();me.test(a)&&(r=a,o=o.slice(0,l).trim())}return o||(o=e),{iconType:i,icon:n,label:o,link:r,raw:e}}function ge(t){return Array.isArray(t)?t.filter(e=>typeof e=="string"):[]}function be(t){return le.some(e=>e.test(t))}function Y(t){return/^https?:\/\//i.test(t)||/^[\w.-]+\.[a-z]{2,}(?:\/|\?|$)/i.test(t)}function xe(t){if(!t?.trim())return null;try{return new URL(t.trim()).hostname.replace(/^www\./,"")}catch{return null}}function ve(t){return!t||t==="answered"?null:t==="insufficient_evidence"?"\uB4F1\uB85D\uB41C \uC790\uB8CC\uC5D0\uC11C \uAD00\uB828 \uC815\uBCF4\uB97C \uCDA9\uBD84\uD788 \uCC3E\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.":t==="restricted"?"\uC548\uC804\uD55C \uC548\uB0B4 \uBC94\uC704\uC5D0\uC11C \uB2F5\uBCC0\uC774 \uC81C\uD55C\uB41C \uC9C8\uBB38\uC785\uB2C8\uB2E4.":t==="conflict"?"\uADFC\uAC70 \uD655\uC778\uC774 \uB354 \uD544\uC694\uD55C \uC9C8\uBB38\uC785\uB2C8\uB2E4.":t==="escalate"?"\uC815\uD655\uD55C \uD655\uC778\uC774 \uD544\uC694\uD55C \uB0B4\uC6A9\uC785\uB2C8\uB2E4.":null}function we(t,e){let i=e?.trim()||null,n=t.documentName?.trim()||"\uCD9C\uCC98",o=t.pageNumber?`p.${t.pageNumber}`:null,s=t.sectionTitle?.trim()||null,r=i&&i!==n?[i,n]:[n];return o&&r.push(o),s&&s!==n&&!Y(s)&&r.push(s),r.join(" | ")}function ye(t){let e=t.sectionTitle?.trim();if(e&&!Y(e))return e;let i=t.documentName?.trim();if(i)return i;let n=t.sourceTitle?.trim();return n||(xe(t.sourceUrl)??"\uCC38\uC870 \uC790\uB8CC")}function ke(t){return t.some(e=>e.sourceUrl?.trim())?"\uCC38\uC870 \uB9C1\uD06C":"\uCC38\uC870 \uC790\uB8CC"}function Ce(t){return t?.citationPresentation==="folded"||t?.citationMode==="compact"}function E(t,e){return e.title?.trim()||t?.institutionName?.trim()||t?.chatbotName?.trim()||"\uAE30\uAD00"}function j(t,e){let i=e.title?.trim()||t?.chatbotName?.trim()||E(t,e);return i.startsWith("AI \uCC57\uBD07")?i:`AI \uCC57\uBD07 ${i}`}function Te(t,e){if(e.welcomeMessage?.trim())return e.welcomeMessage.trim();if(t?.introMessage?.trim())return t.introMessage.trim();if(t?.welcomeMessage?.trim())return t.welcomeMessage.trim();let i=E(t,e);return i&&i!=="\uAE30\uAD00"?`\uC548\uB155\uD558\uC138\uC694. ${i} AI \uC0C1\uB2F4\uBD07\uC785\uB2C8\uB2E4. \uAD81\uAE08\uD558\uC2E0 \uB0B4\uC6A9\uC744 \uD3B8\uD558\uAC8C \uC785\uB825\uD574\uC8FC\uC138\uC694.`:"\uC548\uB155\uD558\uC138\uC694. \uAD81\uAE08\uD558\uC2E0 \uB0B4\uC6A9\uC744 \uC785\uB825\uD574\uC8FC\uC2DC\uBA74 \uBE60\uB974\uAC8C \uC548\uB0B4\uD574\uB4DC\uB9AC\uACA0\uC2B5\uB2C8\uB2E4."}function q(t){return t==="forest"?"linear-gradient(135deg, #166534, #0f766e)":t==="sky"?"linear-gradient(135deg, #1d4ed8, #0284c7)":t==="civic"?"linear-gradient(135deg, #1e40af, #0f766e)":t==="sunset"?"linear-gradient(135deg, #b45309, #ea580c)":"linear-gradient(135deg, #2563EB, #22C55E)"}function Le(t){let e=t?.theme?.launcherIcon;return e==="custom"&&t?.theme?.launcherIconUrl?.trim()?"custom":e==="love-chat"||e==="heart"||e==="shield"||e==="leaf"||e==="spark"?e:"chat"}function Me(t){let e=t.initialLauncherIcon?.trim(),i=t.initialLauncherIconUrl?.trim();return e==="custom"&&i?"custom":e==="love-chat"||e==="heart"||e==="shield"||e==="leaf"||e==="spark"?e:"chat"}function F(t,e){return t==="love-chat"||t==="custom"&&!!e?.trim()}function Ae(t,e){let i=t?.launcherHoverMessage?.trim();return i||`${E(t,e)} AI \uC0C1\uB2F4\uBD07\uC785\uB2C8\uB2E4. \uBB34\uC5C7\uC744 \uB3C4\uC640\uB4DC\uB9B4\uAE4C\uC694?`}function Ee(t){let e=t.match(/#[0-9a-fA-F]{6,8}|#[0-9a-fA-F]{3}/);return e?e[0]:"#2563eb"}function C(t,e){let i=t.replace("#",""),n=i.length===3?i.split("").map(l=>l+l).join(""):i,o=parseInt(n.slice(0,2),16),s=parseInt(n.slice(2,4),16),r=parseInt(n.slice(4,6),16);return`rgba(${o},${s},${r},${e})`}function V(t){let e=Ee(t),i=C(e,.18),n=C(e,.35),o=C(e,.4),s=C(e,.28),r=C(e,.12),l=C(e,.08);return`
:host { all: initial; }
.ieum-root, .ieum-root * {
...
.ieum-starter-card-icon {
  ...
  background:${l}; color:${e}; font-size:22px; line-height:1; flex:0 0 auto;
}
...
.ieum-input:focus { border-color:${e}; background:#fff; box-shadow:0 0 0 3px ${l}; }
.ieum-send {
...
`}var L=class{constructor(e){p(this,"options");p(this,"api");p(this,"host");p(this,"shadow");p(this,"root");p(this,"launcherWrap");p(this,"launcherTip");p(this,"launcherTipText");p(this,"launcherTipClose");p(this,"floatingButton");p(this,"panel");p(this,"titleNode");p(this,"headerIconNode");p(this,"bannerWrap");p(this,"starterQuestionsWrap");p(this,"quickActionsWrap");p(this,"messagesWrap");p(this,"loadingRow");p(this,"input");p(this,"sendButton");p(this,"footerNotice");p(this,"brandMark");p(this,"initialized",!1);p(this,"open",!1);p(this,"sending",!1);p(this,"launcherTipDismissed",!1);p(this,"launcherHoverMessage","");p(this,"launcherTipStorageKey","");p(this,"sessionToken",`widget_${Math.random().toString(36).slice(2,10)}_${Date.now().toString(36)}`);p(this,"config",null);p(this,"chatEndpoint","/chat/messages");p(this,"chatStreamEndpoint","/chat/messages/stream");p(this,"sseEnabled",!1);p(this,"messages",[]);p(this,"lastFailedQuestion",null);p(this,"pinMessageIdToTop",null);this.options=e,this.api=new T(de(e.apiBaseUrl)),this.host=document.createElement("div"),this.host.setAttribute("data-ieumbot-widget-root","true"),this.host.setAttribute("data-ieumbot-chatbot-id",e.chatbotId),this.shadow=this.host.attachShadow({mode:"open"}),this.root=c(document,"div","ieum-root"),this.launcherWrap=c(document,"div","ieum-launcher-wrap"),this.launcherTip=c(document,"div","ieum-launcher-tip"),this.launcherTipText=c(document,"div","ieum-launcher-tip-text"),this.launcherTipClose=c(document,"button","ieum-launcher-tip-close"),this.floatingButton=c(document,"button","ieum-floating"),this.panel=c(document,"div","ieum-panel"),this.titleNode=c(document,"div","ieum-title"),this.headerIconNode=c(document,"div","ieum-header-icon"),this.bannerWrap=c(document,"div","ieum-banner"),this.starterQuestionsWrap=c(document,"div","ieum-starter-questions"),this.quickActionsWrap=c(document,"div","ieum-quick-actions"),this.messagesWrap=c(document,"div","ieum-messages"),this.loadingRow=c(document,"div","ieum-loading"),this.input=c(document,"input","ieum-input"),this.sendButton=c(document,"button","ieum-send"),this.footerNotice=c(document,"div","ieum-footer"),this.brandMark=c(document,"div","ieum-brand"),this.launcherTipClose.type="button",this.launcherTipClose.setAttribute("aria-label","\uC548\uB0B4 \uB2EB\uAE30"),this.launcherTipClose.innerHTML=v("close"),this.launcherTip.appendChild(this.launcherTipText),this.launcherTip.appendChild(this.launcherTipClose),this.floatingButton.type="button",this.floatingButton.title=(e.initialLauncherLabel?.trim()||e.launcherLabel)??"\uCC57\uBD07 \uC5F4\uAE30",this.floatingButton.setAttribute("aria-label",(e.initialLauncherLabel?.trim()||e.launcherLabel)??"\uCC57\uBD07 \uC5F4\uAE30"),this.floatingButton.classList.add("ieum-floating-loading"),this.floatingButton.replaceChildren();let i=Me(e),n=e.initialLauncherIconUrl?.trim();this.floatingButton.innerHTML=v(i,n),this.floatingButton.classList.toggle("ieum-floating-image",F(i,n)),this.titleNode.textContent=j(null,e),this.loadingRow.innerHTML=`
      <span class="ieum-loading-dot"></span>
      <span class="ieum-loading-dot"></span>
      <span class="ieum-loading-dot"></span>
    `,this.input.placeholder="\uBB34\uC5C7\uC744 \uB3C4\uC640\uB4DC\uB9B4\uAE4C\uC694?",this.sendButton.type="button",this.sendButton.setAttribute("aria-label","\uBA54\uC2DC\uC9C0 \uC804\uC1A1"),this.sendButton.innerHTML=v("send"),this.footerNotice.textContent=Q,this.brandMark.innerHTML='<span class="ieum-brand-inner">Powered by <svg class="ieum-brand-logo" viewBox="0 0 24 24" width="12" height="12" aria-hidden="true"><path d="M12 2.2 19.5 5 V11 C19.5 15.8 16.2 19.2 12 21.6 C7.8 19.2 4.5 15.8 4.5 11 V5 Z" fill="#2f6df6"/><path d="M8.3 11.9 11 14.6 15.8 9.4" stroke="#fff" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg><b class="ieum-brand-name"><span style="color:#1f2937">Deep</span><span style="color:#2f6df6">Secu</span></b></span>'}async mount(){if(this.initialized)return;this.initialized=!0;let e=document.createElement("style");e.textContent=V(q(this.options.theme?.primaryColor??null)),this.shadow.appendChild(e),this.shadow.appendChild(this.root);let i=c(document,"div","ieum-header"),n=c(document,"div","ieum-header-main"),o=c(document,"div","ieum-header-actions"),s=c(document,"button","ieum-header-button"),r=c(document,"button","ieum-header-button"),l=c(document,"div","ieum-input-wrap");this.headerIconNode.innerHTML=v("heart"),s.type="button",s.title="\uCD5C\uC18C\uD654",s.setAttribute("aria-label","\uCD5C\uC18C\uD654"),s.innerHTML=v("minimize"),r.type="button",r.title="\uB2EB\uAE30",r.setAttribute("aria-label","\uB2EB\uAE30"),r.innerHTML=v("close"),n.appendChild(this.headerIconNode),n.appendChild(this.titleNode),o.appendChild(s),o.appendChild(r),i.appendChild(n),i.appendChild(o),l.appendChild(this.input),l.appendChild(this.sendButton),this.panel.appendChild(i),this.panel.appendChild(this.bannerWrap),this.panel.appendChild(this.messagesWrap),this.panel.appendChild(this.starterQuestionsWrap),this.panel.appendChild(this.quickActionsWrap),this.panel.appendChild(this.loadingRow),this.panel.appendChild(l),this.panel.appendChild(this.footerNotice),this.panel.appendChild(this.brandMark),this.launcherWrap.appendChild(this.launcherTip),this.launcherWrap.appendChild(this.floatingButton),this.root.appendChild(this.panel),this.root.appendChild(this.launcherWrap),document.body.appendChild(this.host),this.floatingButton.addEventListener("click",()=>this.togglePanel()),this.floatingButton.addEventListener("mouseenter",()=>this.showLauncherTip()),this.floatingButton.addEventListener("focus",()=>this.showLauncherTip()),this.floatingButton.addEventListener("blur",()=>this.hideLauncherTip()),this.launcherTip.addEventListener("mouseenter",()=>this.showLauncherTip()),this.launcherWrap.addEventListener("mouseleave",()=>{this.launcherTipDismissed&&this.hideLauncherTip()}),this.launcherTipClose.addEventListener("click",a=>{a.stopPropagation(),this.dismissLauncherTip()}),s.addEventListener("click",()=>this.setOpen(!1)),r.addEventListener("click",()=>this.setOpen(!1)),this.bindPanelDrag(i),this.sendButton.addEventListener("click",()=>void this.sendCurrentInput()),this.input.addEventListener("keydown",a=>{a.key==="Enter"&&!a.shiftKey&&(a.preventDefault(),this.sendCurrentInput())}),this.ensureInitialMessage(),this.loadConfig(),this.options.openOnLoad&&this.setOpen(!0)}bindPanelDrag(e){let i=!1,n=0,o=0,s=0,r=0,l=u=>{if(!i)return;let d=this.panel.getBoundingClientRect(),h=40,f=Math.min(Math.max(s+(u.clientX-n),h-d.width),window.innerWidth-h),m=Math.min(Math.max(r+(u.clientY-o),0),window.innerHeight-h);this.panel.style.left=`${f}px`,this.panel.style.top=`${m}px`},a=()=>{i&&(i=!1,this.panel.classList.remove("dragging"),document.removeEventListener("mousemove",l),document.removeEventListener("mouseup",a))};e.addEventListener("mousedown",u=>{if(u.button!==0||window.innerWidth<=640||u.target.closest(".ieum-header-button"))return;let d=this.panel.getBoundingClientRect();i=!0,n=u.clientX,o=u.clientY,s=d.left,r=d.top,this.panel.style.position="fixed",this.panel.style.right="auto",this.panel.style.bottom="auto",this.panel.style.left=`${s}px`,this.panel.style.top=`${r}px`,this.panel.classList.add("dragging"),document.addEventListener("mousemove",l),document.addEventListener("mouseup",a),u.preventDefault()})}ensureInitialMessage(){this.messages.length>0||(this.pushMessage({id:`assistant_welcome_${Date.now()}`,role:"assistant",text:Te(this.config,this.options),timestamp:Date.now()}),this.config?.operatingHours.isAfterHours&&this.config.operatingHours.message&&this.pushMessage({id:`system_after_hours_${Date.now()}`,role:"system",text:this.config.operatingHours.message,timestamp:Date.now()}))}clearInitialWelcomeForDirectQuestion(){if(this.messages.some(i=>i.role==="user"))return;let e=this.messages.filter(i=>!i.id.startsWith("assistant_welcome_"));e.length!==this.messages.length&&(this.messages=e,this.renderMessages())}readLauncherTipDismissed(){return!1}dismissLauncherTip(){this.launcherTipDismissed=!0,this.hideLauncherTip()}showLauncherTip(e={}){this.open||!this.launcherHoverMessage.trim()||e.respectDismissed&&this.launcherTipDismissed||this.launcherTip.classList.add("visible")}hideLauncherTip(){this.launcherTip.classList.remove("visible")}async loadConfig(){try{this.config=await this.api.getConfig(this.options.chatbotId);let e=this.shadow.querySelector("style");e&&(e.textContent=V(q(this.config.theme?.preset))),this.titleNode.textContent=j(this.config,this.options),this.config.logoUrl?.trim()?this.headerIconNode.innerHTML=`<img src="${this.config.logoUrl}" alt="\uAE30\uAD00 \uB85C\uACE0" />`:this.headerIconNode.innerHTML=v("heart");let i=Le(this.config),n=this.config.theme?.launcherIconUrl;this.floatingButton.replaceChildren(),this.floatingButton.innerHTML=v(i,n),this.floatingButton.classList.toggle("ieum-floating-image",F(i,n)),this.launcherHoverMessage=Ae(this.config,this.options)??"",this.launcherTipText.textContent=this.launcherHoverMessage,this.launcherTipStorageKey=`ieumbot_launcher_tip_dismissed:${this.options.chatbotId}`,this.launcherTipDismissed=this.readLauncherTipDismissed(),this.showLauncherTip({respectDismissed:!0}),this.renderBanner(),this.renderStarterQuestions(),this.footerNotice.textContent=this.config.privacyNotice?.trim()||Q,this.renderQuickActions(this.config.quickActions),this.config.runtime?.chatEndpoint&&(this.chatEndpoint=this.config.runtime.chatEndpoint),this.config.runtime?.chatStreamEndpoint&&(this.chatStreamEndpoint=this.config.runtime.chatStreamEndpoint),this.sseEnabled=ue(this.config.runtime?.sseEnabled)===!0||this.config.runtime?.streamingMode==="sse_preferred",this.messages.length===1&&this.messages[0]?.id.startsWith("assistant_welcome_")&&(this.messages=[]),this.ensureInitialMessage()}catch{this.pushMessage({id:`system_load_error_${Date.now()}`,role:"system",text:"\uCD08\uAE30 \uC124\uC815\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694.",timestamp:Date.now()})}finally{this.floatingButton.classList.remove("ieum-floating-loading")}}renderBanner(){this.bannerWrap.innerHTML="";let e=this.config?.banner?.title?.trim(),i=this.config?.banner?.description?.trim();if(!e&&!i){this.bannerWrap.style.display="none";return}if(this.bannerWrap.style.display="block",e){let n=c(document,"div","ieum-banner-title");n.textContent=e,this.bannerWrap.appendChild(n)}if(i){let n=c(document,"div","ieum-banner-description");n.textContent=i,this.bannerWrap.appendChild(n)}}renderStarterQuestions(){this.starterQuestionsWrap.innerHTML="";let e=this.config?.starterQuestions?.filter(s=>s.trim()).slice(0,6)??[];if(e.length===0){this.starterQuestionsWrap.style.display="none";return}let i=e.map(s=>fe(s)),n=this.config?.starterQuestionStyle,o=n==="banner"||n!=="list"&&i.some(s=>s.iconType!=="none");if(this.starterQuestionsWrap.classList.toggle("ieum-starter-banner",o),o){let s=i.length,r=s<=3?s:s===4?2:3;this.starterQuestionsWrap.style.display="grid",this.starterQuestionsWrap.style.gridTemplateColumns=`repeat(${r}, 1fr)`}else this.starterQuestionsWrap.style.display="flex",this.starterQuestionsWrap.style.gridTemplateColumns="";for(let{iconType:s,icon:r,label:l,link:a,raw:u}of i){let d=c(document,"button","ieum-starter-question");d.type="button";let h=l||u;if(a&&d.classList.add("ieum-starter-link"),o){if(d.classList.add("ieum-starter-card"),s!=="none"){let m=c(document,"span","ieum-starter-card-icon");s==="svg"?m.innerHTML=K[r]??"":(m.classList.add("ieum-starter-card-icon-emoji"),m.textContent=r),d.appendChild(m)}let f=c(document,"span","ieum-starter-card-label");f.textContent=l,d.appendChild(f)}else d.textContent=l;d.addEventListener("click",()=>{if(a){/^(tel:|mailto:)/i.test(a)?window.location.href=a:window.open(a,"_blank","noopener,noreferrer");return}this.input.value=h,this.sendCurrentInput()}),this.starterQuestionsWrap.appendChild(d)}}renderQuickActions(e){this.quickActionsWrap.innerHTML="";let i=e.filter(n=>n.displayLocation==="welcome").slice(0,6);if(i.length===0){this.quickActionsWrap.style.display="none";return}this.quickActionsWrap.style.display="flex";for(let n of i){let o=c(document,"button","ieum-quick-action");o.type="button",o.textContent=n.label,o.title=n.label,o.addEventListener("click",()=>{if(n.actionType==="link"&&n.url){window.open(n.url,"_blank","noopener,noreferrer");return}this.input.value=n.payload?.trim()||n.label,this.sendCurrentInput()}),this.quickActionsWrap.appendChild(o)}}createQuickReplyHintsRow(){if(this.messages.some(o=>o.role==="user"))return null;let i=(this.config?.quickReplyHints??[]).filter(o=>o.trim()).slice(0,5);if(i.length===0)return null;let n=c(document,"div","ieum-hints-row");n.dataset.role="hints";for(let o of i){let s=c(document,"button","ieum-hint-btn");s.type="button",s.textContent=o,s.addEventListener("click",()=>{this.input.value=o,this.sendCurrentInput(),n.style.display="none"}),n.appendChild(s)}return n}setOpen(e){if(this.open=e,e){this.hideLauncherTip(),this.ensureInitialMessage(),this.panel.classList.add("open"),this.launcherWrap.style.opacity="0",this.launcherWrap.style.pointerEvents="none",this.input.focus(),this.scrollMessagesToBottom();return}this.panel.classList.remove("open"),this.launcherWrap.style.opacity="1",this.launcherWrap.style.pointerEvents="auto"}togglePanel(){this.setOpen(!this.open)}pushMessage(e){this.messages.push(e),this.renderMessages()}updateMessage(e,i){let n=this.messages.findIndex(o=>o.id===e);n<0||(this.messages[n]={...this.messages[n],...i},this.renderMessages())}removeMessage(e){this.messages=this.messages.filter(i=>i.id!==e),this.renderMessages()}renderMessages(){this.messagesWrap.innerHTML="",this.starterQuestionsWrap.style.display=this.messages.length<=1?this.starterQuestionsWrap.style.display:"none";for(let e of this.messages){let i=c(document,"div",`ieum-message ${e.role}`);i.dataset.messageId=e.id;let n=c(document,"div","ieum-bubble");e.id.startsWith("assistant_welcome_")&&n.classList.add("ieum-bubble-welcome");let o=e.structuredResponse;if(o&&e.role==="assistant")if(o.type==="text"){if(n.textContent=o.content,o.moreLink){let s=c(document,"a","ieum-more-link");s.href=o.moreLink.url,s.target="_blank",s.rel="noopener noreferrer",s.textContent=`\u2192 ${o.moreLink.title}`,n.appendChild(s)}}else if(o.type==="view"){let s=o;n.textContent="";let r=c(document,"div","ieum-view-card"),l=c(document,"div","ieum-view-title");l.textContent=s.title,r.appendChild(l);for(let a of s.content){let u=c(document,"p","ieum-view-content");u.textContent=a,r.appendChild(u)}if(s.moreLink){let a=c(document,"a","ieum-more-link");a.href=s.moreLink.url,a.target="_blank",a.rel="noopener noreferrer",a.textContent=`\u2192 ${s.moreLink.title}`,r.appendChild(a)}n.appendChild(r)}else if(o.type==="list"){let s=o;n.textContent="";let r=c(document,"ul","ieum-list");for(let l of s.items.slice(0,8)){let a=c(document,"li","ieum-list-item"),u=c(document,"div","ieum-list-item-title");u.textContent=l.title,a.appendChild(u);for(let d of l.contents.slice(0,3)){let h=c(document,"p","ieum-list-item-content");h.textContent=d,a.appendChild(h)}if(l.targetLink){let d=c(document,"a","ieum-list-item-link");d.href=l.targetLink,d.target="_blank",d.rel="noopener noreferrer",d.textContent=l.targetLinkLabel||"\uC790\uC138\uD788 \uBCF4\uAE30",a.appendChild(d)}else if(l.sourceLinkPath){let d=c(document,"a","ieum-list-item-link");d.href=l.sourceLinkPath,d.target="_blank",d.rel="noopener noreferrer",d.textContent=l.sourceLinkLabel||"\uCD9C\uCC98 \uBCF4\uAE30",a.appendChild(d)}r.appendChild(a)}if(n.appendChild(r),s.moreLink){let l=c(document,"a","ieum-more-link");l.href=s.moreLink.url,l.target="_blank",l.rel="noopener noreferrer",l.textContent=`\u2192 ${s.moreLink.title}`,n.appendChild(l)}}else O(n,e.text);else O(n,e.text);if(e.role==="assistant"){let s=ve(e.outcome);if(s){let r=c(document,"div","ieum-outcome-note");r.textContent=s,n.appendChild(r)}if(e.id){let r=c(document,"div","ieum-feedback-row");r.dataset.messageId=e.id;let l=c(document,"button","ieum-feedback-btn");l.setAttribute("aria-label","\uB3C4\uC6C0\uC774 \uB410\uC5B4\uC694"),l.textContent="\u{1F44D}";let a=c(document,"button","ieum-feedback-btn");a.setAttribute("aria-label","\uB3C4\uC6C0\uC774 \uC548 \uB410\uC5B4\uC694"),a.textContent="\u{1F44E}";let u=async d=>{let h=r.dataset.messageId;if(h)try{await this.api.sendFeedback(h,d),l.classList.toggle("ieum-feedback-active",d===1),a.classList.toggle("ieum-feedback-active",d===-1),setTimeout(()=>{r.innerHTML='<span class="ieum-feedback-thanks">\uD53C\uB4DC\uBC31 \uAC10\uC0AC\uD569\uB2C8\uB2E4</span>'},800)}catch{}};l.addEventListener("click",()=>{!!(e.followUpQuestions&&e.followUpQuestions.length>0)?(e.id&&this.api.sendFeedback(e.id,1).catch(()=>{}),this.input.value="\uB124",this.sendCurrentInput()):u(1)}),a.addEventListener("click",()=>{u(-1)}),r.appendChild(l),r.appendChild(a),n.appendChild(r)}if(e.citations&&e.citations.length>0){let r=Ce(this.config),l=ke(e.citations),a=c(document,r?"details":"div",r?"ieum-citations ieum-citations-folded":"ieum-citations"),u=c(document,r?"summary":"div","ieum-citations-title");u.textContent=r?`${l} ${Math.min(e.citations.length,5)}\uAC74`:l,a.appendChild(u);for(let d of e.citations.slice(0,5)){let h=c(document,"div","ieum-citation"),f=d.sourceUrl?.trim();if(f){let m=c(document,"a","ieum-citation-link");m.href=f,m.target="_blank",m.rel="noopener noreferrer",m.textContent=ye(d),h.appendChild(m)}else h.textContent=we(d,this.config?.institutionName);a.appendChild(h)}n.appendChild(a)}if(e.followUpQuestions&&e.followUpQuestions.length>0){let r=c(document,"div","ieum-follow-ups"),l=c(document,"div","ieum-follow-ups-title");l.textContent="\u2726 \uC774\uB7F0 \uC9C8\uBB38\uB4E4\uC740 \uC5B4\uB5A0\uC2E0\uAC00\uC694?",r.appendChild(l);for(let a of e.followUpQuestions.slice(0,3)){let u=c(document,"button","ieum-follow-up-btn");u.type="button";let d=c(document,"span","ieum-follow-up-icon");d.textContent="\u{1F4AC}";let h=c(document,"span","ieum-follow-up-text");h.textContent=a;let f=c(document,"span","ieum-follow-up-arrow");f.textContent="\u2192",u.appendChild(d),u.appendChild(h),u.appendChild(f),u.addEventListener("click",()=>{this.input.value=a,this.sendCurrentInput()}),r.appendChild(u)}n.appendChild(r)}if(e.conditionalActions&&e.conditionalActions.length>0){let r=c(document,"div","ieum-cta-wrap"),l=c(document,"div","ieum-cta-title");l.textContent="\uAD00\uB828 \uC815\uBCF4",r.appendChild(l);for(let a of e.conditionalActions){let u=a.type==="link"?"\u{1F517}":a.type==="video"?"\u{1F3AC}":a.type==="file"?"\u{1F4CE}":"\u{1F4DE}",d=a.type==="contact"&&!a.value.startsWith("tel:")&&!a.value.startsWith("mailto:")?`tel:${a.value}`:a.value,h=c(document,"a","ieum-cta-btn");h.href=d,h.target=a.type==="contact"?"_self":"_blank",h.rel="noopener noreferrer",h.textContent=`${u} ${a.label}`,a.description&&(h.title=a.description),r.appendChild(h)}n.appendChild(r)}}if(i.appendChild(n),this.messagesWrap.appendChild(i),e.id.startsWith("assistant_welcome_")){let s=this.createQuickReplyHintsRow();s&&this.messagesWrap.appendChild(s)}}if(this.lastFailedQuestion){let e=c(document,"div","ieum-message system"),i=c(document,"button","ieum-quick-action");i.type="button",i.textContent="\uB2E4\uC2DC \uC2DC\uB3C4",i.addEventListener("click",()=>{this.lastFailedQuestion&&(this.input.value=this.lastFailedQuestion,this.sendCurrentInput())}),e.appendChild(i),this.messagesWrap.appendChild(e)}this.scrollAfterRender()}scrollMessagesToBottom(){requestAnimationFrame(()=>{this.messagesWrap.scrollTop=this.messagesWrap.scrollHeight})}scrollAfterRender(){let e=this.pinMessageIdToTop;requestAnimationFrame(()=>{if(e){let i=null,n=this.messagesWrap.children;for(let o=0;o<n.length;o+=1){let s=n[o];if(s.dataset&&s.dataset.messageId===e){i=s;break}}if(i){let o=this.messagesWrap.getBoundingClientRect().top,s=i.getBoundingClientRect().top;this.messagesWrap.scrollTop+=s-o-10;return}}this.messagesWrap.scrollTop=this.messagesWrap.scrollHeight})}setSending(e){this.sending=e,this.sendButton.disabled=e,this.input.disabled=e,this.loadingRow.classList.toggle("active",e)}async sendCurrentInput(){if(this.sending)return;let e=this.input.value.trim();if(e){if(this.pinMessageIdToTop=null,be(e)){this.clearInitialWelcomeForDirectQuestion(),this.lastFailedQuestion=null,this.input.value="",this.pushMessage({id:`assistant_privacy_${Date.now()}`,role:"assistant",text:ae,outcome:"restricted",timestamp:Date.now()}),this.input.focus();return}if(this.clearInitialWelcomeForDirectQuestion(),this.lastFailedQuestion=null,this.input.value="",this.pushMessage({id:`user_${Date.now()}`,role:"user",text:e,timestamp:Date.now()}),this.setSending(!0),this.sseEnabled&&await this.trySendWithSse(e)){this.setSending(!1),this.input.focus();return}try{let i=await this.api.sendChat({chatbotId:this.options.chatbotId,question:e,topK:this.options.topK??8,sessionToken:this.sessionToken,sourceUrl:this.options.sourceUrl??window.location.href},this.chatEndpoint);this.handleAssistantResponse(i)}catch{this.lastFailedQuestion=e,this.pushMessage({id:`system_send_error_${Date.now()}`,role:"system",text:N,timestamp:Date.now()})}finally{this.setSending(!1),this.input.focus()}}}async trySendWithSse(e){let i=`assistant_stream_${Date.now()}`,n=!1,o="\uC2A4\uD2B8\uB9AC\uBC0D \uC5F0\uACB0 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4. \uC77C\uBC18 \uBAA8\uB4DC\uB85C \uC804\uD658\uD569\uB2C8\uB2E4.",s="answered",r=[],l=[],a=[],u="",d=!1;this.pinMessageIdToTop=i,this.pushMessage({id:i,role:"assistant",text:"",timestamp:Date.now()});let h=f=>{let m=f.data??{};if(f.event==="message_delta"){let b=k(m.delta)??"";u+=b,b&&(d=!0),this.updateMessage(i,{text:u});return}if(f.event==="message_complete"){s=k(m.outcome)??s,d=!0,this.updateMessage(i,{outcome:s,text:u||"..."});return}if(f.event==="fallback"||f.event==="escalation"){s=k(m.outcome)??(f.event==="escalation"?"escalate":"insufficient_evidence"),u=k(m.message)??"",d=!0,this.updateMessage(i,{text:u,outcome:s});return}if(f.event==="citations"){r=pe(m.items),this.updateMessage(i,{citations:r});return}if(f.event==="follow_up_questions"){l=ge(m.items).slice(0,3),this.updateMessage(i,{followUpQuestions:l});return}if(f.event==="conditional_actions"){a=he(m.items),this.updateMessage(i,{conditionalActions:a});return}if(f.event==="structured_response"){this.updateMessage(i,{structuredResponse:m});return}if(f.event==="error"){n=!0,o=k(m.message)??o;return}if(f.event==="done"){let b=k(m.sessionToken);b&&(this.sessionToken=b)}};try{if(await this.api.streamChat({chatbotId:this.options.chatbotId,question:e,topK:this.options.topK??8,sessionToken:this.sessionToken,sourceUrl:this.options.sourceUrl??window.location.href},h,this.chatStreamEndpoint),n)throw new Error(o);return u.trim()?this.updateMessage(i,{text:u,outcome:s,citations:r,followUpQuestions:l,conditionalActions:a}):this.updateMessage(i,{text:"\uC694\uCCAD\uC744 \uCC98\uB9AC\uD558\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.",outcome:"insufficient_evidence"}),!0}catch{return d?(this.updateMessage(i,{text:u||"\uC751\uB2F5 \uC218\uC2E0 \uC911 \uC5F0\uACB0\uC774 \uC885\uB8CC\uB418\uC5C8\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694.",outcome:s,citations:r,followUpQuestions:l,conditionalActions:a}),this.lastFailedQuestion=e,!0):(this.updateMessage(i,{text:N,outcome:"insufficient_evidence"}),this.lastFailedQuestion=e,!0)}}handleAssistantResponse(e){let i=e.trace?.messages?.sessionToken;i&&typeof i=="string"&&(this.sessionToken=i);let n=e.answer?.text?.trim()||"\uC548\uB0B4 \uAC00\uB2A5\uD55C \uB2F5\uBCC0\uC744 \uC0DD\uC131\uD558\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.",o=`assistant_${e.requestId}`;this.pinMessageIdToTop=o,this.pushMessage({id:o,role:"assistant",text:n,outcome:e.outcome,citations:Array.isArray(e.citations)?e.citations:[],followUpQuestions:Array.isArray(e.followUpQuestions)?e.followUpQuestions.slice(0,3):[],conditionalActions:Array.isArray(e.conditionalActions)?e.conditionalActions:[],structuredResponse:e.structuredResponse??null,timestamp:Date.now()})}};var I=new Set;async function Z(t){if(!t?.chatbotId)throw new Error("WIDGET_INIT_REQUIRES_CHATBOT_ID");let e=t.chatbotId,i=Array.from(document.querySelectorAll('[data-ieumbot-widget-root="true"]'));for(let o of i)o.getAttribute("data-ieumbot-chatbot-id")===t.chatbotId&&o.remove();if(I.delete(e),I.has(e))return;await new L(t).mount(),I.add(e)}window.IEUMBOTWidget={init:Z};var y=document.currentScript;if(y){let t=y.getAttribute("data-chatbot-id");if(t){let e=y.getAttribute("data-launcher-label")??void 0;Z({chatbotId:t,apiBaseUrl:y.getAttribute("data-api-base-url")??void 0,openOnLoad:y.getAttribute("data-open-on-load")==="true",launcherLabel:e,initialLauncherLabel:e,initialLauncherIcon:y.getAttribute("data-launcher-icon")??void 0,initialLauncherIconUrl:y.getAttribute("data-launcher-icon-url")??void 0})}}})();
