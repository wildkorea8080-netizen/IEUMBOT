...
`));i({event:T,data:g})}catch{i({event:"error",data:{code:"STREAM_EVENT_PARSE_FAILED",message:"\uC2A4\uD2B8\uB9BC \uC774\uBCA4\uD2B8 \uD30C\uC2F1 \uC2E4\uD328"}})}}}}};var B="/widget-icons/love-chat-icons.png";function D(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function k(t){return`<img class="ieum-launcher-image" src="${D(t.trim())}" alt="" aria-hidden="true" />`}function a(t,e,i){let n=t.createElement(e);return i&&(n.className=i),n}function m(t,e){return t==="custom"&&e?.trim()?k(e):t==="love-chat"?k(B):t==="heart"?`
  ...
  `}function _(t){return t&&t.trim()?t.replace(/\/$/,""):`${window.location.origin}/api`}function f(t){return typeof t=="string"?t:void 0}function N(t){return typeof t=="boolean"?t:void 0}function $(t){return Array.isArray(t)?t:[]}function O(t){return!t||t==="answered"?null:t==="insufficient_evidence"?"\uD655\uC778 \uAC00\uB2A5\uD55C \uCC38\uACE0 \uB0B4\uC6A9\uC774 \uBD80\uC871\uD574 \uC77C\uBC18 \uC548\uB0B4\uB85C \uC804\uD658\uD588\uC2B5\uB2C8\uB2E4.":t==="restricted"?"\uC9C1\uC811 \uC548\uB0B4\uAC00 \uC5B4\uB824\uC6B4 \uC9C8\uBB38\uC774\uB77C \uC548\uC804\uD55C \uBC94\uC704\uC5D0\uC11C\uB9CC \uB2F5\uBCC0\uD569\uB2C8\uB2E4.":t==="conflict"?"\uADFC\uAC70 \uD655\uC778\uC774 \uB354 \uD544\uC694\uD55C \uC9C8\uBB38\uC785\uB2C8\uB2E4.":t==="escalate"?"\uCD94\uAC00 \uD655\uC778\uC774 \uD544\uC694\uD55C \uB0B4\uC6A9\uC73C\uB85C \uC0C1\uB2F4 \uC5F0\uACB0\uC774 \uAD8C\uC7A5\uB429\uB2C8\uB2E4.":null}function q(t){let e=t.documentName?.trim()||"\uCD9C\uCC98",i=t.pageNumber?`p.${t.pageNumber}`:null,n=t.sectionTitle?.trim()||null,o=t.sourceUrl?.trim()||null,r=[e];return i&&r.push(i),n&&n!==e&&n!==o&&r.push(n),o&&r.push(o),r.join(" | ")}function C(t,e){return e.title?.trim()||t?.institutionName?.trim()||t?.chatbotName?.trim()||"\uAE30\uAD00"}function M(t,e){let i=C(t,e);return i.startsWith("AI \uCC57\uBD07")?i:`AI \uCC57\uBD07 ${i}`}function R(t,e){return e.welcomeMessage?.trim()?e.welcomeMessage.trim():t?.introMessage?.trim()?t.introMessage.trim():t?.welcomeMessage?.trim()?t.welcomeMessage.trim():`\uC548\uB155\uD558\uC138\uC694
${C(t,e)} AI \uCC57\uBD07\uC785\uB2C8\uB2E4.

\uAD81\uAE08\uD558\uC2E0 \uB0B4\uC6A9\uC744 \uC785\uB825\uD574\uC8FC\uC2DC\uBA74
\uBE60\uB974\uAC8C \uC548\uB0B4\uD574\uB4DC\uB9AC\uACA0\uC2B5\uB2C8\uB2E4.`}function L(t){return t==="forest"?"linear-gradient(135deg, #166534, #0f766e)":t==="sky"?"linear-gradient(135deg, #1d4ed8, #0284c7)":t==="civic"?"linear-gradient(135deg, #1e40af, #0f766e)":t==="sunset"?"linear-gradient(135deg, #b45309, #ea580c)":"linear-gradient(135deg, #2563EB, #22C55E)"}function P(t){let e=t?.theme?.launcherIcon;return e==="custom"&&t?.theme?.launcherIconUrl?.trim()?"custom":e==="love-chat"||e==="heart"||e==="shield"||e==="leaf"||e==="spark"?e:"chat"}function j(t,e){let i=t?.launcherHoverMessage?.trim();return i||`AI\uCC57\uBD07 ${C(t,e)}\uC608\uC694. \uBB34\uC5C7\uC744 \uB3C4\uC640\uB4DC\uB9B4\uAE4C\uC694?`}function E(t){return`
:host { all: initial; }
.ieum-root, .ieum-root * {
