"use strict";(()=>{var oe=Object.defineProperty;var se=(i,e,t)=>e in i?oe(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var f=(i,e,t)=>se(i,typeof e!="symbol"?e+"":e,t);function re(i){return i.endsWith("/")?i.slice(0,-1):i}var I=class{constructor(e){f(this,"baseUrl");this.baseUrl=re(e)}async getConfig(e){let t=await fetch(`${this.baseUrl}/widget/config/${encodeURIComponent(e)}`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"omit"});if(!t.ok)throw new Error(`WIDGET_CONFIG_FAILED:${t.status}`);return await t.json()}async getConsultationSnapshot(e,t){let n=await fetch(`${this.baseUrl}/widget/consultation/${encodeURIComponent(e)}/${encodeURIComponent(t)}`,{method:"GET",headers:{"Content-Type":"application/json"},credentials:"omit"});if(!n.ok)throw new Error(`WIDGET_SNAPSHOT_FAILED:${n.status}`);return await n.json()}async sendChat(e,t="/chat/messages"){let n=t.startsWith("/")?t:`/${t}`,s=await fetch(`${this.baseUrl}${n}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),credentials:"omit"});if(!s.ok)throw new Error(`WIDGET_CHAT_FAILED:${s.status}`);return await s.json()}async sendFeedback(e,t){await fetch(`${this.baseUrl}/chat/messages/${encodeURIComponent(e)}/feedback`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({feedback:t}),credentials:"omit"})}async streamChat(e,t,n="/chat/messages/stream"){let s=n.startsWith("/")?n:`/${n}`,o=await fetch(`${this.baseUrl}${s}`,{method:"POST",headers:{"Content-Type":"application/json",Accept:"text/event-stream"},body:JSON.stringify(e),credentials:"omit"});if(!o.ok||!o.body)throw new Error(`WIDGET_CHAT_STREAM_FAILED:${o.status}`);let r=o.body.getReader(),a=new TextDecoder("utf-8"),d="";for(;;){let{value:u,done:c}=await r.read();if(c)break;d+=a.decode(u,{stream:!0});let p=d.indexOf(`

`);for(;p!==-1;){let h=d.slice(0,p).trim();if(d=d.slice(p+2),p=d.indexOf(`

`),!h)continue;let m="message",g=[];for(let b of h.split(`
`))b.startsWith("event:")?m=b.slice(6).trim():b.startsWith("data:")&&g.push(b.slice(5).trim());if(g.length!==0)try{let b=JSON.parse(g.join(`
`));t({event:m,data:b})}catch{t({event:"error",data:{code:"STREAM_EVENT_PARSE_FAILED",message:"\uC2A4\uD2B8\uB9BC \uC774\uBCA4\uD2B8 \uD30C\uC2F1 \uC2E4\uD328"}})}}}}};function ae(i){return i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function k(i){let e=i;return e=e.replace(/`([^`]+)`/g,(t,n)=>`<code>${n}</code>`),e=e.replace(/\[([^\]]+)\]\(([^)\s]+)\)/g,(t,n,s)=>`<a href="${s}">${n}</a>`),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/(^|[^*])\*([^*\n]+)\*(?!\*)/g,"$1<em>$2</em>"),e=e.replace(/(^|[^_])_([^_\n]+)_(?!_)/g,"$1<em>$2</em>"),e}function D(i){let e=i.trim();return e.startsWith("|")&&(e=e.slice(1)),e.endsWith("|")&&(e=e.slice(0,-1)),e.split("|").map(t=>t.trim())}var _=/^\s*\|.*\|\s*$/,le=/^\s*\|?[\s:-]*-[-\s:|]*\|?\s*$/,N=/^(#{1,6})\s+(.*)$/,U=/^\s*[-*]\s+(.*)$/,O=/^\s*\d+\.\s+(.*)$/,Q=/^\s*>\s+(.*)$/;function P(i){return/(^|\n)\s*\|.*\|/.test(i)||/\*\*[^*]+\*\*/.test(i)||/(^|\n)\s*[-*]\s+\S/.test(i)||/(^|\n)\s*\d+\.\s+\S/.test(i)||/(^|\n)#{1,6}\s+\S/.test(i)||/\[[^\]]+\]\([^)]+\)/.test(i)||/(^|\n)>\s+\S/.test(i)}function j(i){let e=ae(i.replace(/\r\n/g,`
`)).split(`
`),t=[],n=null,s=()=>{n&&(t.push(`</${n}>`),n=null)},o=0;for(;o<e.length;){let r=e[o];if(_.test(r)&&o+1<e.length&&le.test(e[o+1])){s();let h=D(r);o+=2;let m=[];for(;o<e.length&&_.test(e[o]);)m.push(D(e[o])),o+=1;let g="<table><thead><tr>"+h.map(b=>`<th>${k(b)}</th>`).join("")+"</tr></thead><tbody>";for(let b of m)g+="<tr>"+b.map(x=>`<td>${k(x)}</td>`).join("")+"</tr>";g+="</tbody></table>",t.push(g);continue}let a=r.match(N);if(a){s(),t.push(`<h${a[1].length}>${k(a[2])}</h${a[1].length}>`),o+=1;continue}let d=r.match(U);if(d){n!=="ul"&&(s(),t.push("<ul>"),n="ul"),t.push(`<li>${k(d[1])}</li>`),o+=1;continue}let u=r.match(O);if(u){n!=="ol"&&(s(),t.push("<ol>"),n="ol"),t.push(`<li>${k(u[1])}</li>`),o+=1;continue}let c=r.match(Q);if(c){s(),t.push(`<blockquote>${k(c[1])}</blockquote>`),o+=1;continue}if(r.trim()===""){s(),o+=1;continue}s();let p=[r];for(o+=1;o<e.length&&e[o].trim()!==""&&!_.test(e[o])&&!N.test(e[o])&&!U.test(e[o])&&!O.test(e[o])&&!Q.test(e[o]);)p.push(e[o]),o+=1;t.push(`<p>${p.map(k).join("<br>")}</p>`)}return s(),t.join("")}var de=new Set(["p","br","div","span","section","article","header","footer","small","sub","sup","h1","h2","h3","h4","h5","h6","strong","em","b","i","u","s","mark","code","pre","ul","ol","li","a","table","thead","tbody","tr","td","th","caption","colgroup","col","blockquote","hr","figure","figcaption","img"]),ce={a:new Set(["href","title"]),img:new Set(["src","alt","title","width","height"]),td:new Set(["colspan","rowspan"]),th:new Set(["colspan","rowspan","scope"]),col:new Set(["span"]),colgroup:new Set(["span"])},ue=new Set(["color","background","background-color","margin","margin-top","margin-right","margin-bottom","margin-left","padding","padding-top","padding-right","padding-bottom","padding-left","gap","row-gap","column-gap","border","border-top","border-right","border-bottom","border-left","border-width","border-style","border-color","border-radius","border-collapse","border-spacing","font","font-size","font-weight","font-style","font-family","line-height","letter-spacing","text-align","text-decoration","text-transform","white-space","word-break","overflow-wrap","vertical-align","width","min-width","max-width","height","min-height","max-height","box-sizing","display","flex","flex-direction","flex-wrap","flex-grow","flex-shrink","flex-basis","align-items","align-self","justify-content","justify-items","grid-template-columns","grid-template-rows","grid-gap","list-style","list-style-type","list-style-position","box-shadow","opacity","overflow","overflow-x","overflow-y"]);function pe(i){let e=[];for(let t of i.split(";")){let n=t.indexOf(":");if(n<0)continue;let s=t.slice(0,n).trim().toLowerCase(),o=t.slice(n+1).trim();if(!ue.has(s))continue;let r=o.toLowerCase();r.includes("url(")||r.includes("expression")||r.includes("javascript:")||r.includes("@import")||r.includes("</")||r.includes("fixed")||r.includes("absolute")||r.includes("sticky")||e.push(`${s}: ${o}`)}return e.join("; ")}var he=/<[a-zA-Z][a-zA-Z0-9]*(\s|>|\/)/;function F(i){return he.test(i)}function q(i){let e=i.trim().toLowerCase();return!(!e||e.startsWith("javascript:")||e.startsWith("data:")||e.startsWith("vbscript:")||e.startsWith("file:"))}function K(i,e){let t=Array.from(i.children);for(let n of t){let s=n.tagName.toLowerCase();if(!de.has(s)){let r=e.createTextNode(n.textContent||"");n.replaceWith(r);continue}let o=ce[s]||new Set;for(let r of Array.from(n.attributes)){let a=r.name.toLowerCase();if(a==="style"){let d=pe(r.value);d?n.setAttribute("style",d):n.removeAttribute("style");continue}o.has(a)||n.removeAttribute(r.name)}if(s==="a"){let r=n.getAttribute("href")||"";q(r)||n.removeAttribute("href"),n.setAttribute("target","_blank"),n.setAttribute("rel","noopener noreferrer")}if(s==="img"){let r=n.getAttribute("src")||"";q(r)||n.removeAttribute("src")}K(n,e)}}function $(i){if(typeof window>"u"||typeof DOMParser>"u")return i.replace(/<[^>]*>/g,"");if(!i)return"";let t=new DOMParser().parseFromString(`<div id="__ieum_root__">${i}</div>`,"text/html"),n=t.getElementById("__ieum_root__");return n?(K(n,t),n.innerHTML):""}var me="/widget-icons/love-chat-icons.png",fe=8,V="\uC694\uCCAD \uCC98\uB9AC \uC911 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694.",ge="\uAC1C\uC778\uC815\uBCF4\uAC00 \uD3EC\uD568\uB41C \uB0B4\uC6A9\uC740 \uC785\uB825\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4. \uAC1C\uC778\uC815\uBCF4\uB97C \uC81C\uC678\uD558\uACE0 \uB2E4\uC2DC \uC785\uB825\uD574 \uC8FC\uC138\uC694.",Y="AI \uC774\uC74C\uBD07\uB3C4 \uAC00\uB054 \uC2E4\uC218\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4. \uC911\uC694\uD55C \uC815\uBCF4\uB294 \uAF2D \uB2E4\uC2DC \uD55C\uBC88 \uD655\uC778\uD558\uC138\uC694.",be=[/\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}\b/,/\b\d{6}-[1-4]\d{6}\b/,/\b\d{4}[- ]?\d{4}[- ]?\d{4}[- ]?\d{4}\b/,/\b01[016789][- ]?\d{3,4}[- ]?\d{4}\b/,/\b(?:19|20)\d{2}[-./](?:0[1-9]|1[0-2])[-./](?:0[1-9]|[12]\d|3[01])\b/];function xe(i){return i.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function G(i){return`<img class="ieum-launcher-image" src="${xe(i.trim())}" alt="" aria-hidden="true" />`}function l(i,e,t){let n=i.createElement(e);return t&&(n.className=t),n}function M(i,e){let t=e||"";F(t)?(i.classList.add("ieum-bubble-rich"),i.innerHTML=$(t)):P(t)?(i.classList.add("ieum-bubble-rich"),i.innerHTML=$(j(t))):(i.classList.remove("ieum-bubble-rich"),i.textContent=t)}function y(i,e){return i==="custom"&&e?.trim()?G(e):i==="love-chat"?G(me):i==="heart"?`
  ...
  `}function we(i){return i&&i.trim()?i.replace(/\/$/,""):`${window.location.origin}/api`}function L(i){return typeof i=="string"?i:void 0}function ve(i){return typeof i=="boolean"?i:void 0}function ye(i){return Array.isArray(i)?i:[]}function ke(i){return Array.isArray(i)?i:[]}var w='fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"',te={doc:`<svg viewBox="0 0 24 24" ${w}><path d="M6 3h8l4 4v14H6z"/><path d="M14 3v4h4"/><path d="M9 12h6M9 16h6"/></svg>`,shield:`<svg viewBox="0 0 24 24" ${w}><path d="M12 3l7 3v5c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6z"/><path d="M9 12l2 2 4-4"/></svg>`,member:`<svg viewBox="0 0 24 24" ${w}><circle cx="10" cy="8" r="3.2"/><path d="M4 20c0-3.3 2.7-5.6 6-5.6 1.2 0 2.3.3 3.2.8"/><path d="M18 14v6M15 17h6"/></svg>`,cert:`<svg viewBox="0 0 24 24" ${w}><circle cx="12" cy="9" r="5.2"/><path d="M9.7 9l1.6 1.6 3-3.2"/><path d="M8.5 13.2 7 20l5-2.6L17 20l-1.5-6.8"/></svg>`,search:`<svg viewBox="0 0 24 24" ${w}><circle cx="11" cy="11" r="6"/><path d="M20 20l-4.3-4.3"/></svg>`,phone:`<svg viewBox="0 0 24 24" ${w}><path d="M6.6 10.8a12 12 0 0 0 5.6 5.6l1.9-1.9a1 1 0 0 1 1-.24 11 11 0 0 0 3.4.55 1 1 0 0 1 1 1V20a1 1 0 0 1-1 1A16 16 0 0 1 3 5a1 1 0 0 1 1-1h3.3a1 1 0 0 1 1 1 11 11 0 0 0 .55 3.4 1 1 0 0 1-.24 1z"/></svg>`,apply:`<svg viewBox="0 0 24 24" ${w}><path d="M5 4h9l4 4v6"/><path d="M14 4v4h4"/><path d="M13 21l-4 1 1-4 6.5-6.5a1.4 1.4 0 0 1 2 2z"/></svg>`,check:`<svg viewBox="0 0 24 24" ${w}><circle cx="12" cy="12" r="8.5"/><path d="M8.5 12.5l2.5 2.5 4.5-5"/></svg>`,info:`<svg viewBox="0 0 24 24" ${w}><circle cx="12" cy="12" r="8.5"/><path d="M12 11v5"/><path d="M12 8h.01"/></svg>`,won:`<svg viewBox="0 0 24 24" ${w}><circle cx="12" cy="12" r="8.5"/><path d="M8 9l1.6 6L12 10l2.4 5L16 9"/><path d="M7.4 11.5h9.2"/></svg>`,grid:`<svg viewBox="0 0 24 24" ${w}><rect x="4" y="4" width="7" height="7" rx="1.5"/><rect x="13" y="4" width="7" height="7" rx="1.5"/><rect x="4" y="13" width="7" height="7" rx="1.5"/><rect x="13" y="13" width="7" height="7" rx="1.5"/></svg>`,chat:`<svg viewBox="0 0 24 24" ${w}><path d="M4 5h16v11H9l-4 3v-3H4z"/><path d="M8 9h8M8 12h5"/></svg>`,calendar:`<svg viewBox="0 0 24 24" ${w}><rect x="4" y="5" width="16" height="15" rx="2"/><path d="M4 9h16M8 3v4M16 3v4"/></svg>`,building:`<svg viewBox="0 0 24 24" ${w}><path d="M5 21V5a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v16"/><path d="M15 9h3a1 1 0 0 1 1 1v11"/><path d="M8 8h4M8 12h4M8 16h4"/></svg>`},Ce=/^(https?:\/\/|tel:|mailto:|\/)/i;function Le(i){let e=i.trim(),t="none",n="",s=e,o=e.match(/^\[([a-z0-9_-]+)\]\s*([\s\S]*)$/i);if(o&&te[o[1].toLowerCase()])t="svg",n=o[1].toLowerCase(),s=o[2].trim();else{let c=e.search(/\s/);if(c>0){let p=e.slice(0,c);!/[0-9A-Za-z가-힣]/.test(p)&&/[←-⯿️‍]|[\u{1F000}-\u{1FAFF}]/u.test(p)&&(t="emoji",n=p,s=e.slice(c+1).trim())}}let r="",a=s.lastIndexOf(" | ");if(a>0){let c=s.slice(a+3).trim();Ce.test(c)&&(r=c,s=s.slice(0,a).trim())}let d="",u=s.indexOf(" :: ");return u>0&&(d=s.slice(u+4).trim(),s=s.slice(0,u).trim()),s||(s=e),{iconType:t,icon:n,label:s,description:d,link:r,raw:e}}function Te(i){return Array.isArray(i)?i.filter(e=>typeof e=="string"):[]}function Me(i){return be.some(e=>e.test(i))}function ie(i){return/^https?:\/\//i.test(i)||/^[\w.-]+\.[a-z]{2,}(?:\/|\?|$)/i.test(i)}function Ae(i){if(!i?.trim())return null;try{return new URL(i.trim()).hostname.replace(/^www\./,"")}catch{return null}}function Ee(i){return!i||i==="answered"?null:i==="insufficient_evidence"?"\uB4F1\uB85D\uB41C \uC790\uB8CC\uC5D0\uC11C \uAD00\uB828 \uC815\uBCF4\uB97C \uCDA9\uBD84\uD788 \uCC3E\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.":i==="restricted"?"\uC548\uC804\uD55C \uC548\uB0B4 \uBC94\uC704\uC5D0\uC11C \uB2F5\uBCC0\uC774 \uC81C\uD55C\uB41C \uC9C8\uBB38\uC785\uB2C8\uB2E4.":i==="conflict"?"\uADFC\uAC70 \uD655\uC778\uC774 \uB354 \uD544\uC694\uD55C \uC9C8\uBB38\uC785\uB2C8\uB2E4.":i==="escalate"?"\uC815\uD655\uD55C \uD655\uC778\uC774 \uD544\uC694\uD55C \uB0B4\uC6A9\uC785\uB2C8\uB2E4.":null}function Ie(i,e){let t=e?.trim()||null,n=i.documentName?.trim()||"\uCD9C\uCC98",s=i.pageNumber?`p.${i.pageNumber}`:null,o=i.sectionTitle?.trim()||null,r=t&&t!==n?[t,n]:[n];return s&&r.push(s),o&&o!==n&&!ie(o)&&r.push(o),r.join(" | ")}function S(i){let e=i.sectionTitle?.trim();if(e&&!ie(e))return e;let t=i.documentName?.trim();if(t)return t;let n=i.sourceTitle?.trim();return n||(Ae(i.sourceUrl)??"\uCC38\uC870 \uC790\uB8CC")}function We(i){return i.some(e=>e.sourceUrl?.trim())?"\uCC38\uC870 \uB9C1\uD06C":"\uCC38\uC870 \uC790\uB8CC"}function _e(i){return i?.citationPresentation==="folded"||i?.citationMode==="compact"}function H(i,e){return e.title?.trim()||i?.institutionName?.trim()||i?.chatbotName?.trim()||"\uAE30\uAD00"}function Z(i,e){let t=e.title?.trim()||i?.chatbotName?.trim()||H(i,e);return t.startsWith("AI \uCC57\uBD07")?t:`AI \uCC57\uBD07 ${t}`}function $e(i,e){if(e.welcomeMessage?.trim())return e.welcomeMessage.trim();if(i?.introMessage?.trim())return i.introMessage.trim();if(i?.welcomeMessage?.trim())return i.welcomeMessage.trim();let t=H(i,e);return t&&t!=="\uAE30\uAD00"?`\uC548\uB155\uD558\uC138\uC694. ${t} AI \uC0C1\uB2F4\uBD07\uC785\uB2C8\uB2E4. \uAD81\uAE08\uD558\uC2E0 \uB0B4\uC6A9\uC744 \uD3B8\uD558\uAC8C \uC785\uB825\uD574\uC8FC\uC138\uC694.`:"\uC548\uB155\uD558\uC138\uC694. \uAD81\uAE08\uD558\uC2E0 \uB0B4\uC6A9\uC744 \uC785\uB825\uD574\uC8FC\uC2DC\uBA74 \uBE60\uB974\uAC8C \uC548\uB0B4\uD574\uB4DC\uB9AC\uACA0\uC2B5\uB2C8\uB2E4."}function J(i){return i==="forest"?"linear-gradient(135deg, #166534, #0f766e)":i==="sky"?"linear-gradient(135deg, #1d4ed8, #0284c7)":i==="civic"?"linear-gradient(135deg, #1e40af, #0f766e)":i==="sunset"?"linear-gradient(135deg, #b45309, #ea580c)":"linear-gradient(135deg, #2563EB, #22C55E)"}function Se(i){let e=i?.theme?.launcherIcon;return e==="custom"&&i?.theme?.launcherIconUrl?.trim()?"custom":e==="love-chat"||e==="heart"||e==="shield"||e==="leaf"||e==="spark"?e:"chat"}function He(i){let e=i.initialLauncherIcon?.trim(),t=i.initialLauncherIconUrl?.trim();return e==="custom"&&t?"custom":e==="love-chat"||e==="heart"||e==="shield"||e==="leaf"||e==="spark"?e:"chat"}function X(i,e){return i==="love-chat"||i==="custom"&&!!e?.trim()}function Be(i,e){let t=i?.launcherHoverMessage?.trim();return t||`${H(i,e)} AI \uC0C1\uB2F4\uBD07\uC785\uB2C8\uB2E4. \uBB34\uC5C7\uC744 \uB3C4\uC640\uB4DC\uB9B4\uAE4C\uC694?`}function Re(i){let e=i.match(/#[0-9a-fA-F]{6,8}|#[0-9a-fA-F]{3}/);return e?e[0]:"#2563eb"}function T(i,e){let t=i.replace("#",""),n=t.length===3?t.split("").map(a=>a+a).join(""):t,s=parseInt(n.slice(0,2),16),o=parseInt(n.slice(2,4),16),r=parseInt(n.slice(4,6),16);return`rgba(${s},${o},${r},${e})`}function ee(i){let e=Re(i),t=T(e,.18),n=T(e,.35),s=T(e,.4),o=T(e,.28),r=T(e,.12),a=T(e,.08);return`
:host { all: initial; }
.ieum-root, .ieum-root * {
...
`}var A=class A{constructor(e){f(this,"options");f(this,"api");f(this,"host");f(this,"shadow");f(this,"root");f(this,"launcherWrap");f(this,"launcherTip");f(this,"launcherTipText");f(this,"launcherTipClose");f(this,"floatingButton");f(this,"panel");f(this,"titleNode");f(this,"headerIconNode");f(this,"bannerWrap");f(this,"trustBadgesWrap");f(this,"starterQuestionsWrap");f(this,"quickActionsWrap");f(this,"messagesWrap");f(this,"loadingRow");f(this,"input");f(this,"sendButton");f(this,"footerNotice");f(this,"brandMark");f(this,"initialized",!1);f(this,"open",!1);f(this,"sending",!1);f(this,"launcherTipDismissed",!1);f(this,"launcherHoverMessage","");f(this,"launcherTipStorageKey","");f(this,"sessionToken",`widget_${Math.random().toString(36).slice(2,10)}_${Date.now().toString(36)}`);f(this,"config",null);f(this,"chatEndpoint","/chat/messages");f(this,"chatStreamEndpoint","/chat/messages/stream");f(this,"sseEnabled",!1);f(this,"messages",[]);f(this,"lastFailedQuestion",null);f(this,"pinMessageIdToTop",null);this.options=e,this.api=new I(we(e.apiBaseUrl)),this.host=document.createElement("div"),this.host.setAttribute("data-ieumbot-widget-root","true"),this.host.setAttribute("data-ieumbot-chatbot-id",e.chatbotId),this.shadow=this.host.attachShadow({mode:"open"}),this.root=l(document,"div","ieum-root"),this.launcherWrap=l(document,"div","ieum-launcher-wrap"),this.launcherTip=l(document,"div","ieum-launcher-tip"),this.launcherTipText=l(document,"div","ieum-launcher-tip-text"),this.launcherTipClose=l(document,"button","ieum-launcher-tip-close"),this.floatingButton=l(document,"button","ieum-floating"),this.panel=l(document,"div","ieum-panel"),this.titleNode=l(document,"div","ieum-title"),this.headerIconNode=l(document,"div","ieum-header-icon"),this.bannerWrap=l(document,"div","ieum-banner"),this.trustBadgesWrap=l(document,"div","ieum-trust-badges"),this.starterQuestionsWrap=l(document,"div","ieum-starter-questions"),this.quickActionsWrap=l(document,"div","ieum-quick-actions"),this.messagesWrap=l(document,"div","ieum-messages"),this.loadingRow=l(document,"div","ieum-loading"),this.input=l(document,"input","ieum-input"),this.sendButton=l(document,"button","ieum-send"),this.footerNotice=l(document,"div","ieum-footer"),this.brandMark=l(document,"div","ieum-brand"),this.launcherTipClose.type="button",this.launcherTipClose.setAttribute("aria-label","\uC548\uB0B4 \uB2EB\uAE30"),this.launcherTipClose.innerHTML=y("close"),this.launcherTip.appendChild(this.launcherTipText),this.launcherTip.appendChild(this.launcherTipClose),this.floatingButton.type="button",this.floatingButton.title=(e.initialLauncherLabel?.trim()||e.launcherLabel)??"\uCC57\uBD07 \uC5F4\uAE30",this.floatingButton.setAttribute("aria-label",(e.initialLauncherLabel?.trim()||e.launcherLabel)??"\uCC57\uBD07 \uC5F4\uAE30"),this.floatingButton.classList.add("ieum-floating-loading"),this.floatingButton.replaceChildren();let t=He(e),n=e.initialLauncherIconUrl?.trim();this.floatingButton.innerHTML=y(t,n),this.floatingButton.classList.toggle("ieum-floating-image",X(t,n)),this.titleNode.textContent=Z(null,e),this.loadingRow.innerHTML=`
      <span class="ieum-loading-dot"></span>
      <span class="ieum-loading-dot"></span>
      <span class="ieum-loading-dot"></span>
    `,this.input.placeholder="\uBB34\uC5C7\uC744 \uB3C4\uC640\uB4DC\uB9B4\uAE4C\uC694?",this.sendButton.type="button",this.sendButton.setAttribute("aria-label","\uBA54\uC2DC\uC9C0 \uC804\uC1A1"),this.sendButton.innerHTML=y("send"),this.titleNode.id="ieum-title-heading",this.titleNode.setAttribute("role","heading"),this.titleNode.setAttribute("aria-level","2"),this.panel.setAttribute("role","dialog"),this.panel.setAttribute("aria-labelledby","ieum-title-heading"),this.messagesWrap.setAttribute("role","log"),this.messagesWrap.setAttribute("aria-live","polite"),this.messagesWrap.setAttribute("aria-relevant","additions text"),this.input.setAttribute("aria-label","\uC9C8\uBB38 \uC785\uB825"),this.floatingButton.setAttribute("aria-haspopup","dialog"),this.floatingButton.setAttribute("aria-expanded","false"),this.footerNotice.textContent=Y,this.brandMark.innerHTML='<span class="ieum-brand-inner">Powered by <svg class="ieum-brand-logo" viewBox="0 0 24 24" width="12" height="12" aria-hidden="true"><path d="M12 2.2 19.5 5 V11 C19.5 15.8 16.2 19.2 12 21.6 C7.8 19.2 4.5 15.8 4.5 11 V5 Z" fill="#2f6df6"/><path d="M8.3 11.9 11 14.6 15.8 9.4" stroke="#fff" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg><b class="ieum-brand-name"><span style="color:#1f2937">Deep</span><span style="color:#2f6df6">Secu</span></b></span>'}async mount(){if(this.initialized)return;this.initialized=!0;let e=document.createElement("style");e.textContent=ee(J(this.options.theme?.primaryColor??null)),this.shadow.appendChild(e),this.shadow.appendChild(this.root);let t=l(document,"div","ieum-header"),n=l(document,"div","ieum-header-main"),s=l(document,"div","ieum-header-actions"),o=l(document,"button","ieum-header-button"),r=l(document,"button","ieum-header-button"),a=l(document,"button","ieum-header-button"),d=l(document,"div","ieum-input-wrap");this.headerIconNode.innerHTML=y("heart"),o.type="button",o.title="\uCC98\uC74C\uC73C\uB85C",o.setAttribute("aria-label","\uCC98\uC74C \uD654\uBA74\uC73C\uB85C (\uB300\uD654 \uC0C8\uB85C \uC2DC\uC791)"),o.innerHTML=y("reset"),r.type="button",r.title="\uCD5C\uC18C\uD654",r.setAttribute("aria-label","\uCD5C\uC18C\uD654"),r.innerHTML=y("minimize"),a.type="button",a.title="\uB2EB\uAE30",a.setAttribute("aria-label","\uB2EB\uAE30"),a.innerHTML=y("close"),n.appendChild(this.headerIconNode),n.appendChild(this.titleNode),s.appendChild(o),s.appendChild(r),s.appendChild(a),t.appendChild(n),t.appendChild(s),d.appendChild(this.input),d.appendChild(this.sendButton),this.panel.appendChild(t),this.panel.appendChild(this.bannerWrap),this.panel.appendChild(this.trustBadgesWrap),this.panel.appendChild(this.messagesWrap),this.panel.appendChild(this.starterQuestionsWrap),this.panel.appendChild(this.quickActionsWrap),this.panel.appendChild(this.loadingRow),this.panel.appendChild(d),this.panel.appendChild(this.footerNotice),this.panel.appendChild(this.brandMark),this.launcherWrap.appendChild(this.launcherTip),this.launcherWrap.appendChild(this.floatingButton),this.root.appendChild(this.panel),this.root.appendChild(this.launcherWrap),document.body.appendChild(this.host),this.floatingButton.addEventListener("click",()=>this.togglePanel()),this.floatingButton.addEventListener("mouseenter",()=>this.showLauncherTip()),this.floatingButton.addEventListener("focus",()=>this.showLauncherTip()),this.floatingButton.addEventListener("blur",()=>this.hideLauncherTip()),this.launcherTip.addEventListener("mouseenter",()=>this.showLauncherTip()),this.launcherWrap.addEventListener("mouseleave",()=>{this.launcherTipDismissed&&this.hideLauncherTip()}),this.launcherTipClose.addEventListener("click",u=>{u.stopPropagation(),this.dismissLauncherTip()}),o.addEventListener("click",()=>this.resetConversation()),r.addEventListener("click",()=>this.setOpen(!1)),a.addEventListener("click",()=>this.setOpen(!1)),this.panel.addEventListener("keydown",u=>{u.key==="Escape"&&this.open&&(u.stopPropagation(),this.setOpen(!1))}),this.bindPanelDrag(t),this.sendButton.addEventListener("click",()=>void this.sendCurrentInput()),this.input.addEventListener("keydown",u=>{u.key==="Enter"&&!u.shiftKey&&(u.preventDefault(),this.sendCurrentInput())}),this.ensureInitialMessage(),this.loadConfig(),this.options.openOnLoad&&this.setOpen(!0)}bindPanelDrag(e){let t=!1,n=0,s=0,o=0,r=0,a=u=>{if(!t)return;let c=this.panel.getBoundingClientRect(),p=40,h=Math.min(Math.max(o+(u.clientX-n),p-c.width),window.innerWidth-p),m=Math.min(Math.max(r+(u.clientY-s),0),window.innerHeight-p);this.panel.style.left=`${h}px`,this.panel.style.top=`${m}px`},d=()=>{t&&(t=!1,this.panel.classList.remove("dragging"),document.removeEventListener("mousemove",a),document.removeEventListener("mouseup",d))};e.addEventListener("mousedown",u=>{if(u.button!==0||window.innerWidth<=640||u.target.closest(".ieum-header-button"))return;let c=this.panel.getBoundingClientRect();t=!0,n=u.clientX,s=u.clientY,o=c.left,r=c.top,this.panel.style.position="fixed",this.panel.style.right="auto",this.panel.style.bottom="auto",this.panel.style.left=`${o}px`,this.panel.style.top=`${r}px`,this.panel.classList.add("dragging"),document.addEventListener("mousemove",a),document.addEventListener("mouseup",d),u.preventDefault()})}ensureInitialMessage(){this.messages.length>0||(this.pushMessage({id:`assistant_welcome_${Date.now()}`,role:"assistant",text:$e(this.config,this.options),timestamp:Date.now()}),this.config?.operatingHours.isAfterHours&&this.config.operatingHours.message&&this.pushMessage({id:`system_after_hours_${Date.now()}`,role:"system",text:this.config.operatingHours.message,timestamp:Date.now()}))}clearInitialWelcomeForDirectQuestion(){}resetConversation(){this.messages=[],this.sessionToken=`widget_${Math.random().toString(36).slice(2,10)}_${Date.now().toString(36)}`,this.ensureInitialMessage(),this.renderMessages(),this.renderStarterQuestions(),this.input.value="",this.messagesWrap.scrollTop=0,this.input.focus()}readLauncherTipDismissed(){return!1}dismissLauncherTip(){this.launcherTipDismissed=!0,this.hideLauncherTip()}showLauncherTip(e={}){this.open||!this.launcherHoverMessage.trim()||e.respectDismissed&&this.launcherTipDismissed||this.launcherTip.classList.add("visible")}hideLauncherTip(){this.launcherTip.classList.remove("visible")}async loadConfig(){try{this.config=await this.api.getConfig(this.options.chatbotId);let e=this.shadow.querySelector("style");e&&(e.textContent=ee(J(this.config.theme?.preset))),this.titleNode.textContent=Z(this.config,this.options),this.config.logoUrl?.trim()?this.headerIconNode.innerHTML=`<img src="${this.config.logoUrl}" alt="\uAE30\uAD00 \uB85C\uACE0" />`:this.headerIconNode.innerHTML=y("heart");let t=Se(this.config),n=this.config.theme?.launcherIconUrl;this.floatingButton.replaceChildren(),this.floatingButton.innerHTML=y(t,n),this.floatingButton.classList.toggle("ieum-floating-image",X(t,n)),this.launcherHoverMessage=Be(this.config,this.options)??"",this.launcherTipText.textContent=this.launcherHoverMessage,this.launcherTipStorageKey=`ieumbot_launcher_tip_dismissed:${this.options.chatbotId}`,this.launcherTipDismissed=this.readLauncherTipDismissed(),this.showLauncherTip({respectDismissed:!0}),this.renderBanner(),this.renderTrustBadges(),this.renderStarterQuestions(),this.footerNotice.textContent=this.config.privacyNotice?.trim()||Y,this.renderQuickActions(this.config.quickActions),this.config.runtime?.chatEndpoint&&(this.chatEndpoint=this.config.runtime.chatEndpoint),this.config.runtime?.chatStreamEndpoint&&(this.chatStreamEndpoint=this.config.runtime.chatStreamEndpoint),this.sseEnabled=ve(this.config.runtime?.sseEnabled)===!0||this.config.runtime?.streamingMode==="sse_preferred",this.messages.length===1&&this.messages[0]?.id.startsWith("assistant_welcome_")&&(this.messages=[]),this.ensureInitialMessage()}catch{this.pushMessage({id:`system_load_error_${Date.now()}`,role:"system",text:"\uCD08\uAE30 \uC124\uC815\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694.",timestamp:Date.now()})}finally{this.floatingButton.classList.remove("ieum-floating-loading")}}async openConsultationSnapshot(e,t){let n=this.shadow.activeElement,s=l(document,"div","ieum-snapshot-overlay"),o=l(document,"div","ieum-snapshot-card");o.setAttribute("role","dialog"),o.setAttribute("aria-modal","true"),s.appendChild(o);let r=()=>{s.remove(),document.removeEventListener("keydown",a),n?.focus?.()},a=h=>{h.key==="Escape"&&r()};s.addEventListener("click",h=>{h.target===s&&r()}),document.addEventListener("keydown",a);let d=l(document,"div","ieum-snapshot-header"),u=l(document,"div","ieum-snapshot-title");u.textContent=S(t);let c=l(document,"button","ieum-snapshot-close");c.type="button",c.setAttribute("aria-label","\uB2EB\uAE30"),c.textContent="\u2715",c.addEventListener("click",r),d.appendChild(u),d.appendChild(c),o.appendChild(d);let p=l(document,"div","ieum-snapshot-body");p.textContent="\uC0C1\uB2F4 \uB0B4\uC6A9\uC744 \uBD88\uB7EC\uC624\uB294 \uC911\u2026",o.appendChild(p),this.root.appendChild(s),c.focus();try{let h=await this.api.getConsultationSnapshot(this.options.chatbotId,e);p.innerHTML="";let m=h.category?.trim();if(m){let v=l(document,"span","ieum-snapshot-badge");v.textContent=m,p.appendChild(v)}let g=[["\uC9C8\uBB38",h.question?.trim()||"(\uB0B4\uC6A9 \uC5C6\uC74C)"],["\uC804\uBB38\uAC00 \uB2F5\uBCC0",h.answer?.trim()||"(\uB0B4\uC6A9 \uC5C6\uC74C)"]];for(let[v,E]of g){let R=l(document,"div","ieum-snapshot-label");R.textContent=v;let z=l(document,"div","ieum-snapshot-text");z.textContent=E,p.appendChild(R),p.appendChild(z)}let b=l(document,"div","ieum-snapshot-source"),x=h.boardLabel?.trim()||"\uC0C1\uB2F4\uAC8C\uC2DC\uD310";b.textContent=h.receiptNo?`\uCD9C\uCC98: ${x} \xB7 ${h.receiptNo}`:`\uCD9C\uCC98: ${x}`,p.appendChild(b)}catch{p.textContent="\uC0C1\uB2F4 \uB0B4\uC6A9\uC744 \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694."}}renderBanner(){this.bannerWrap.innerHTML="";let e=this.config?.banner?.title?.trim(),t=this.config?.banner?.description?.trim();if(!e&&!t){this.bannerWrap.style.display="none";return}if(this.bannerWrap.style.display="block",e){let n=l(document,"div","ieum-banner-title");n.textContent=e,this.bannerWrap.appendChild(n)}if(t){let n=l(document,"div","ieum-banner-description");n.textContent=t,this.bannerWrap.appendChild(n)}}renderTrustBadges(){this.trustBadgesWrap.innerHTML="";let e=(this.config?.trustBadges??[]).filter(t=>t&&t.label?.trim());if(e.length===0){this.trustBadgesWrap.style.display="none";return}this.trustBadgesWrap.style.display="flex";for(let t of e.slice(0,4)){let n=l(document,"span","ieum-trust-badge"),s=(t.icon??"").trim();if(s){let r=l(document,"span","ieum-trust-icon");r.textContent=s,n.appendChild(r)}let o=l(document,"span");o.textContent=t.label.trim(),n.appendChild(o),this.trustBadgesWrap.appendChild(n)}}renderStarterQuestions(){this.starterQuestionsWrap.innerHTML="";let e=this.config?.starterQuestions?.filter(a=>a.trim()).slice(0,6)??[];if(e.length===0){this.starterQuestionsWrap.style.display="none";return}let t=e.map(a=>Le(a)),n=this.config?.starterQuestionStyle,s=t.some(a=>a.description),o=!s&&(n==="banner"||n!=="list"&&t.some(a=>a.iconType!=="none"));if(this.starterQuestionsWrap.classList.toggle("ieum-starter-rich",s),this.starterQuestionsWrap.classList.toggle("ieum-starter-banner",o),o||s){let a=t.length,d=a<=3?a:a===4?2:3;this.starterQuestionsWrap.style.display="grid",this.starterQuestionsWrap.style.gridTemplateColumns=`repeat(${d}, 1fr)`}else this.starterQuestionsWrap.style.display="flex",this.starterQuestionsWrap.style.gridTemplateColumns="";let r=(a,d,u)=>{if(a==="none")return null;let c=l(document,"span",u);return a==="svg"?c.innerHTML=te[d]??"":(c.style.background="transparent",c.textContent=d),c};for(let{iconType:a,icon:d,label:u,description:c,link:p,raw:h}of t){let m=l(document,"button","ieum-starter-question");m.type="button";let g=u||h;if(p&&m.classList.add("ieum-starter-link"),s){m.classList.add("ieum-starter-rich-card");let b=r(a,d,"ieum-starter-rich-icon");b&&m.appendChild(b);let x=l(document,"span","ieum-starter-rich-body"),v=l(document,"span","ieum-starter-rich-title");if(v.textContent=u,x.appendChild(v),c){let E=l(document,"span","ieum-starter-rich-desc");E.textContent=c,x.appendChild(E)}m.appendChild(x)}else if(o){m.classList.add("ieum-starter-card");let b=r(a,d,"ieum-starter-card-icon");b&&m.appendChild(b);let x=l(document,"span","ieum-starter-card-label");x.textContent=u,m.appendChild(x)}else m.textContent=u;m.addEventListener("click",()=>{if(p){/^(tel:|mailto:)/i.test(p)?window.location.href=p:window.open(p,"_blank","noopener,noreferrer");return}this.input.value=g,this.sendCurrentInput()}),this.starterQuestionsWrap.appendChild(m)}}renderQuickActions(e){if(this.quickActionsWrap.innerHTML="",e.some(s=>s.actionType==="category"&&e.some(o=>o.parentId===s.id))){this.quickActionsWrap.style.display="none";return}let n=e.filter(s=>s.displayLocation==="welcome").slice(0,6);if(n.length===0){this.quickActionsWrap.style.display="none";return}this.quickActionsWrap.style.display="flex";for(let s of n){let o=l(document,"button","ieum-quick-action");o.type="button",o.textContent=s.label,o.title=s.label,o.addEventListener("click",()=>{this.handleMenuAction(s)}),this.quickActionsWrap.appendChild(o)}}async handleMenuAction(e){if(e.actionType==="link"&&e.url){window.open(e.url,"_blank","noopener,noreferrer");return}if(e.actionType==="category"){let t=Date.now();this.pushMessage({id:`user_menu_${e.id}_${t}`,role:"user",text:`# ${e.label}`,timestamp:t}),this.pushMessage({id:`menu_card_${e.id}_${t+1}`,role:"assistant",text:"",timestamp:t+1,menuCategoryId:e.id});return}this.input.value=e.payload?.trim()||e.label,await this.sendCurrentInput()}pushRootMenuCard(){this.pushMessage({id:`menu_root_${Date.now()}`,role:"assistant",text:"",timestamp:Date.now(),menuCategoryId:A.MENU_ROOT})}fillMenuCard(e,t){let n=this.config?.quickActions??[],s=t===A.MENU_ROOT,o=s?n.filter(h=>h.actionType==="category"&&n.some(m=>m.parentId===h.id)):n.filter(h=>h.parentId===t),r=s?null:n.find(h=>h.id===t);if(o.length===0||!s&&!r){let h=l(document,"div","ieum-menu-card-desc");h.textContent="\uC774 \uBA54\uB274\uB294 \uB354 \uC774\uC0C1 \uC0AC\uC6A9\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.",e.appendChild(h);return}let a=l(document,"div","ieum-menu-card-title");a.textContent=s?"\uBB34\uC5C7\uC744 \uB3C4\uC640\uB4DC\uB9B4\uAE4C\uC694?":r.label,e.appendChild(a);let d=s?"\uC544\uB798\uC5D0\uC11C \uC6D0\uD558\uC2DC\uB294 \uD56D\uBAA9\uC744 \uC120\uD0DD\uD558\uAC70\uB098, \uC790\uC720\uB86D\uAC8C \uC9C8\uBB38\uD574 \uC8FC\uC138\uC694.":r.description;if(d){let h=l(document,"div","ieum-menu-card-desc");h.textContent=d,e.appendChild(h)}let u=o.every(h=>h.label.trim().length<=fe),c=l(document,"div",`ieum-menu-card-actions ${u?"ieum-menu-card-grid":"ieum-menu-card-list"}`);for(let h of o){let m=l(document,"button","ieum-quick-action ieum-menu-entry");m.type="button",m.textContent=h.label,m.title=h.label,m.addEventListener("click",()=>{this.handleMenuAction(h)}),c.appendChild(m)}if(e.appendChild(c),s)return;let p=l(document,"button","ieum-menu-home");p.type="button",p.textContent="\u2191 \uCC98\uC74C\uC73C\uB85C",p.addEventListener("click",()=>{this.pushRootMenuCard()}),e.appendChild(p)}createQuickReplyHintsRow(){if(this.messages.some(s=>s.role==="user"))return null;let t=(this.config?.quickReplyHints??[]).filter(s=>s.trim()).slice(0,5);if(t.length===0)return null;let n=l(document,"div","ieum-hints-row");n.dataset.role="hints";for(let s of t){let o=l(document,"button","ieum-hint-btn");o.type="button",o.textContent=s,o.addEventListener("click",()=>{this.input.value=s,this.sendCurrentInput(),n.style.display="none"}),n.appendChild(o)}return n}setOpen(e){if(this.open=e,this.floatingButton.setAttribute("aria-expanded",e?"true":"false"),e){this.hideLauncherTip(),this.ensureInitialMessage(),this.panel.classList.add("open"),this.launcherWrap.style.opacity="0",this.launcherWrap.style.pointerEvents="none",this.input.focus(),this.scrollMessagesToBottom();return}this.panel.classList.remove("open"),this.launcherWrap.style.opacity="1",this.launcherWrap.style.pointerEvents="auto";try{this.floatingButton.focus()}catch{}}togglePanel(){this.setOpen(!this.open)}pushMessage(e){this.messages.push(e),this.renderMessages()}updateMessage(e,t){let n=this.messages.findIndex(s=>s.id===e);n<0||(this.messages[n]={...this.messages[n],...t},this.renderMessages())}removeMessage(e){this.messages=this.messages.filter(t=>t.id!==e),this.renderMessages()}renderMessages(){this.messagesWrap.innerHTML="",this.starterQuestionsWrap.style.display=this.messages.length<=1?this.starterQuestionsWrap.style.display:"none";for(let e of this.messages){let t=l(document,"div",`ieum-message ${e.role}`);t.dataset.messageId=e.id;let n=l(document,"div","ieum-bubble");if(e.id.startsWith("assistant_welcome_")&&n.classList.add("ieum-bubble-welcome"),e.menuCategoryId){n.classList.add("ieum-menu-card"),this.fillMenuCard(n,e.menuCategoryId),t.appendChild(n),this.messagesWrap.appendChild(t);continue}let s=e.structuredResponse;if(s&&e.role==="assistant")if(s.type==="text"){if(M(n,s.content),s.moreLink){let o=l(document,"a","ieum-more-link");o.href=s.moreLink.url,o.target="_blank",o.rel="noopener noreferrer",o.textContent=`\u2192 ${s.moreLink.title}`,n.appendChild(o)}}else if(s.type==="view"){let o=s;n.textContent="";let r=l(document,"div","ieum-view-card"),a=l(document,"div","ieum-view-title");a.textContent=o.title,r.appendChild(a);for(let d of o.content){let u=l(document,"div","ieum-view-content");M(u,d),r.appendChild(u)}if(o.moreLink){let d=l(document,"a","ieum-more-link");d.href=o.moreLink.url,d.target="_blank",d.rel="noopener noreferrer",d.textContent=`\u2192 ${o.moreLink.title}`,r.appendChild(d)}n.appendChild(r)}else if(s.type==="list"){let o=s;n.textContent="";let r=l(document,"ul","ieum-list");for(let a of o.items.slice(0,8)){let d=l(document,"li","ieum-list-item"),u=l(document,"div","ieum-list-item-title");u.textContent=a.title,d.appendChild(u);for(let c of a.contents.slice(0,3)){let p=l(document,"div","ieum-list-item-content");M(p,c),d.appendChild(p)}if(a.targetLink){let c=l(document,"a","ieum-list-item-link");c.href=a.targetLink,c.target="_blank",c.rel="noopener noreferrer",c.textContent=a.targetLinkLabel||"\uC790\uC138\uD788 \uBCF4\uAE30",d.appendChild(c)}else if(a.sourceLinkPath){let c=l(document,"a","ieum-list-item-link");c.href=a.sourceLinkPath,c.target="_blank",c.rel="noopener noreferrer",c.textContent=a.sourceLinkLabel||"\uCD9C\uCC98 \uBCF4\uAE30",d.appendChild(c)}r.appendChild(d)}if(n.appendChild(r),o.moreLink){let a=l(document,"a","ieum-more-link");a.href=o.moreLink.url,a.target="_blank",a.rel="noopener noreferrer",a.textContent=`\u2192 ${o.moreLink.title}`,n.appendChild(a)}}else M(n,e.text);else M(n,e.text);if(e.role==="assistant"){let o=Ee(e.outcome);if(o){let r=l(document,"div","ieum-outcome-note");r.textContent=o,n.appendChild(r)}if(e.id){let r=l(document,"div","ieum-feedback-row");r.dataset.messageId=e.id;let a=l(document,"button","ieum-feedback-btn");a.setAttribute("aria-label","\uB3C4\uC6C0\uC774 \uB410\uC5B4\uC694"),a.textContent="\u{1F44D}";let d=l(document,"button","ieum-feedback-btn");d.setAttribute("aria-label","\uB3C4\uC6C0\uC774 \uC548 \uB410\uC5B4\uC694"),d.textContent="\u{1F44E}";let u=async c=>{let p=r.dataset.messageId;if(p)try{await this.api.sendFeedback(p,c),a.classList.toggle("ieum-feedback-active",c===1),d.classList.toggle("ieum-feedback-active",c===-1),setTimeout(()=>{r.innerHTML='<span class="ieum-feedback-thanks">\uD53C\uB4DC\uBC31 \uAC10\uC0AC\uD569\uB2C8\uB2E4</span>'},800)}catch{}};a.addEventListener("click",()=>{!!(e.followUpQuestions&&e.followUpQuestions.length>0)?(e.id&&this.api.sendFeedback(e.id,1).catch(()=>{}),this.input.value="\uB124",this.sendCurrentInput()):u(1)}),d.addEventListener("click",()=>{u(-1)}),r.appendChild(a),r.appendChild(d),n.appendChild(r)}if(e.citations&&e.citations.length>0){let r=_e(this.config),a=We(e.citations),d=l(document,r?"details":"div",r?"ieum-citations ieum-citations-folded":"ieum-citations"),u=l(document,r?"summary":"div","ieum-citations-title");u.textContent=r?`${a} ${Math.min(e.citations.length,5)}\uAC74`:a,d.appendChild(u);for(let c of e.citations.slice(0,5)){let p=l(document,"div","ieum-citation"),h=c.sourceUrl?.trim();if((c.extractionMethod??"").toLowerCase()==="seoul_labor"&&!!c.chunkId?.trim()){let g=c.chunkId,b=l(document,"button","ieum-citation-link ieum-citation-snapshot");b.type="button",b.textContent=S(c),b.addEventListener("click",()=>{this.openConsultationSnapshot(g,c)}),p.appendChild(b);let x=c.category?.trim();if(x){let v=l(document,"span","ieum-citation-badge");v.textContent=x,p.appendChild(v)}}else if(h){let g=l(document,"a","ieum-citation-link");g.href=h,g.target="_blank",g.rel="noopener noreferrer",g.textContent=S(c),p.appendChild(g)}else p.textContent=Ie(c,this.config?.institutionName);d.appendChild(p)}n.appendChild(d)}if(e.followUpQuestions&&e.followUpQuestions.length>0){let r=l(document,"div","ieum-follow-ups"),a=l(document,"div","ieum-follow-ups-title");a.textContent="\u2726 \uC774\uB7F0 \uC9C8\uBB38\uB4E4\uC740 \uC5B4\uB5A0\uC2E0\uAC00\uC694?",r.appendChild(a);for(let d of e.followUpQuestions.slice(0,3)){let u=l(document,"button","ieum-follow-up-btn");u.type="button";let c=l(document,"span","ieum-follow-up-icon");c.textContent="\u{1F4AC}";let p=l(document,"span","ieum-follow-up-text");p.textContent=d;let h=l(document,"span","ieum-follow-up-arrow");h.textContent="\u2192",u.appendChild(c),u.appendChild(p),u.appendChild(h),u.addEventListener("click",()=>{this.input.value=d,this.sendCurrentInput()}),r.appendChild(u)}n.appendChild(r)}if(e.conditionalActions&&e.conditionalActions.length>0){let r=l(document,"div","ieum-cta-wrap"),a=l(document,"div","ieum-cta-title");a.textContent="\uAD00\uB828 \uC815\uBCF4",r.appendChild(a);for(let d of e.conditionalActions){let u=d.type==="link"?"\u{1F517}":d.type==="video"?"\u{1F3AC}":d.type==="file"?"\u{1F4CE}":"\u{1F4DE}",c=d.type==="contact"&&!d.value.startsWith("tel:")&&!d.value.startsWith("mailto:")?`tel:${d.value}`:d.value,p=l(document,"a","ieum-cta-btn");p.href=c,p.target=d.type==="contact"?"_self":"_blank",p.rel="noopener noreferrer",p.textContent=`${u} ${d.label}`,d.description&&(p.title=d.description),r.appendChild(p)}n.appendChild(r)}}if(t.appendChild(n),this.messagesWrap.appendChild(t),e.id.startsWith("assistant_welcome_")){let o=this.createQuickReplyHintsRow();o&&this.messagesWrap.appendChild(o)}}if(this.lastFailedQuestion){let e=l(document,"div","ieum-message system"),t=l(document,"button","ieum-quick-action");t.type="button",t.textContent="\uB2E4\uC2DC \uC2DC\uB3C4",t.addEventListener("click",()=>{this.lastFailedQuestion&&(this.input.value=this.lastFailedQuestion,this.sendCurrentInput())}),e.appendChild(t),this.messagesWrap.appendChild(e)}this.scrollAfterRender()}scrollMessagesToBottom(){requestAnimationFrame(()=>{this.messagesWrap.scrollTop=this.messagesWrap.scrollHeight})}scrollAfterRender(){let e=this.pinMessageIdToTop;requestAnimationFrame(()=>{if(e){let t=null,n=this.messagesWrap.children;for(let s=0;s<n.length;s+=1){let o=n[s];if(o.dataset&&o.dataset.messageId===e){t=o;break}}if(t){let s=this.messagesWrap.getBoundingClientRect().top,o=t.getBoundingClientRect().top;this.messagesWrap.scrollTop+=o-s-10;return}}this.messagesWrap.scrollTop=this.messagesWrap.scrollHeight})}setSending(e){this.sending=e,this.sendButton.disabled=e,this.input.disabled=e,this.loadingRow.classList.toggle("active",e)}findMenuCategoryByLabel(e){let t=e.trim().toLowerCase();if(!t)return null;let n=this.config?.quickActions??[];return n.find(s=>s.actionType==="category"&&s.label.trim().toLowerCase()===t&&n.some(o=>o.parentId===s.id))??null}async sendCurrentInput(){if(this.sending)return;let e=this.input.value.trim();if(!e)return;let t=this.findMenuCategoryByLabel(e);if(t){this.input.value="",this.clearInitialWelcomeForDirectQuestion(),await this.handleMenuAction(t),this.input.focus();return}if(this.pinMessageIdToTop=null,Me(e)){this.clearInitialWelcomeForDirectQuestion(),this.lastFailedQuestion=null,this.input.value="",this.pushMessage({id:`assistant_privacy_${Date.now()}`,role:"assistant",text:ge,outcome:"restricted",timestamp:Date.now()}),this.input.focus();return}if(this.clearInitialWelcomeForDirectQuestion(),this.lastFailedQuestion=null,this.input.value="",this.pushMessage({id:`user_${Date.now()}`,role:"user",text:e,timestamp:Date.now()}),this.setSending(!0),this.sseEnabled&&await this.trySendWithSse(e)){this.setSending(!1),this.input.focus();return}try{let n=await this.api.sendChat({chatbotId:this.options.chatbotId,question:e,topK:this.options.topK??8,sessionToken:this.sessionToken,sourceUrl:this.options.sourceUrl??window.location.href},this.chatEndpoint);this.handleAssistantResponse(n)}catch{this.lastFailedQuestion=e,this.pushMessage({id:`system_send_error_${Date.now()}`,role:"system",text:V,timestamp:Date.now()})}finally{this.setSending(!1),this.input.focus()}}async trySendWithSse(e){let t=`assistant_stream_${Date.now()}`,n=!1,s="\uC2A4\uD2B8\uB9AC\uBC0D \uC5F0\uACB0 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4. \uC77C\uBC18 \uBAA8\uB4DC\uB85C \uC804\uD658\uD569\uB2C8\uB2E4.",o="answered",r=[],a=[],d=[],u="",c=!1;this.pinMessageIdToTop=t,this.pushMessage({id:t,role:"assistant",text:"",timestamp:Date.now()});let p=h=>{let m=h.data??{};if(h.event==="message_delta"){let g=L(m.delta)??"";u+=g,g&&(c=!0),this.updateMessage(t,{text:u});return}if(h.event==="message_complete"){o=L(m.outcome)??o,c=!0,this.updateMessage(t,{outcome:o,text:u||"..."});return}if(h.event==="fallback"||h.event==="escalation"){o=L(m.outcome)??(h.event==="escalation"?"escalate":"insufficient_evidence"),u=L(m.message)??"",c=!0,this.updateMessage(t,{text:u,outcome:o});return}if(h.event==="citations"){r=ye(m.items),this.updateMessage(t,{citations:r});return}if(h.event==="follow_up_questions"){a=Te(m.items).slice(0,3),this.updateMessage(t,{followUpQuestions:a});return}if(h.event==="conditional_actions"){d=ke(m.items),this.updateMessage(t,{conditionalActions:d});return}if(h.event==="structured_response"){this.updateMessage(t,{structuredResponse:m});return}if(h.event==="error"){n=!0,s=L(m.message)??s;return}if(h.event==="done"){let g=L(m.sessionToken);g&&(this.sessionToken=g)}};try{if(await this.api.streamChat({chatbotId:this.options.chatbotId,question:e,topK:this.options.topK??8,sessionToken:this.sessionToken,sourceUrl:this.options.sourceUrl??window.location.href},p,this.chatStreamEndpoint),n)throw new Error(s);return u.trim()?this.updateMessage(t,{text:u,outcome:o,citations:r,followUpQuestions:a,conditionalActions:d}):this.updateMessage(t,{text:"\uC694\uCCAD\uC744 \uCC98\uB9AC\uD558\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.",outcome:"insufficient_evidence"}),!0}catch{return c?(this.updateMessage(t,{text:u||"\uC751\uB2F5 \uC218\uC2E0 \uC911 \uC5F0\uACB0\uC774 \uC885\uB8CC\uB418\uC5C8\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694.",outcome:o,citations:r,followUpQuestions:a,conditionalActions:d}),this.lastFailedQuestion=e,!0):(this.updateMessage(t,{text:V,outcome:"insufficient_evidence"}),this.lastFailedQuestion=e,!0)}}handleAssistantResponse(e){let t=e.trace?.messages?.sessionToken;t&&typeof t=="string"&&(this.sessionToken=t);let n=e.answer?.text?.trim()||"\uC548\uB0B4 \uAC00\uB2A5\uD55C \uB2F5\uBCC0\uC744 \uC0DD\uC131\uD558\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4.",s=`assistant_${e.requestId}`;this.pinMessageIdToTop=s,this.pushMessage({id:s,role:"assistant",text:n,outcome:e.outcome,citations:Array.isArray(e.citations)?e.citations:[],followUpQuestions:Array.isArray(e.followUpQuestions)?e.followUpQuestions.slice(0,3):[],conditionalActions:Array.isArray(e.conditionalActions)?e.conditionalActions:[],structuredResponse:e.structuredResponse??null,timestamp:Date.now()})}};f(A,"MENU_ROOT","__root__");var W=A;var B=new Set;async function ne(i){if(!i?.chatbotId)throw new Error("WIDGET_INIT_REQUIRES_CHATBOT_ID");let e=i.chatbotId,t=Array.from(document.querySelectorAll('[data-ieumbot-widget-root="true"]'));for(let s of t)s.getAttribute("data-ieumbot-chatbot-id")===i.chatbotId&&s.remove();if(B.delete(e),B.has(e))return;await new W(i).mount(),B.add(e)}window.IEUMBOTWidget={init:ne};var C=document.currentScript;if(C){let i=C.getAttribute("data-chatbot-id");if(i){let e=C.getAttribute("data-launcher-label")??void 0;ne({chatbotId:i,apiBaseUrl:C.getAttribute("data-api-base-url")??void 0,openOnLoad:C.getAttribute("data-open-on-load")==="true",launcherLabel:e,initialLauncherLabel:e,initialLauncherIcon:C.getAttribute("data-launcher-icon")??void 0,initialLauncherIconUrl:C.getAttribute("data-launcher-icon-url")??void 0})}}})();
