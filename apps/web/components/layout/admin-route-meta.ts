...
const ADMIN_ROUTE_META: Array<{ href: string; meta: RouteMeta }> = [
  { href: "/admin/dashboard", meta: { title: "대시보드", breadcrumbs: ["기관관리자", "대시보드"] } },
  ...
  { href: "/admin/install-guide", meta: { title: "설치 가이드", breadcrumbs: ["기관관리자", "운영", "설치 가이드"] } },
  { href: "/admin/security", meta: { title: "보안", breadcrumbs: ["기관관리자", "운영", "보안"] } },
  { href: "/admin/usage", meta: { title: "사용량", breadcrumbs: ["기관관리자", "운영", "사용량"] } },
  ...
  { href: "/admin/escalations", meta: { title: "이관 설정", breadcrumbs: ["기관관리자", "고급", "이관 설정"] } },
  { href: "/admin/widget", meta: { title: "위젯", breadcrumbs: ["기관관리자", "고급", "위젯"] } },
  { href: "/admin/chat-logs", meta: { title: "채팅 로그", breadcrumbs: ["기관관리자", "고급", "채팅 로그"] } },
...
export function getAdminRouteMeta(pathname: string): RouteMeta {
  ...
  return matched?.meta ?? { title: "기관관리자", breadcrumbs: ["기관관리자"] };
}
