...
const MENUS = {
  수도권매립지관리공사: [
    ...
    },
    {
      ...
      children: [
        { label: "견학 예약", payload: "견학 예약은 어떻게 하나요?" },
    ...
    },
    {
      ...
      children: [
        ...
        { label: "신고센터", payload: "부패·갑질 신고는 어디에 하나요?" },
      ],
    },
    {
      label: "기관 안내",
      ...
      children: [
        ...
        { label: "찾아오시는 길", payload: "찾아오시는 길을 알려주세요." },
        { label: "채용 공고", payload: "채용 공고는 어디서 확인하나요?" },
    ...
    },
    {
      ...
      children: [
        ...
        { label: "환경경영", payload: "환경경영은 어떻게 하고 있나요?" },
  ...
  한국수자원조사기술원: [
    {
      ...
      children: [
        ...
        { label: "검정증명서 발급", payload: "검정증명서는 어떻게 발급받나요?" },
    ...
    },
    {
      ...
      children: [
        { label: "공지사항", payload: "공지사항은 어디서 확인하나요?" },
